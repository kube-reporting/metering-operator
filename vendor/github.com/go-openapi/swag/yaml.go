...
// YAMLDoc loads a yaml document from either http or a ***REMOVED***le and converts it to json
...
// YAMLData loads a yaml document from either http or a ***REMOVED***le
