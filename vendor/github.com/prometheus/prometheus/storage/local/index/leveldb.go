...
import (
	...
	leveldb_***REMOVED***lter "github.com/syndtr/goleveldb/leveldb/***REMOVED***lter"
...
type LevelDBOptions struct {
	Path           string // Base path to store ***REMOVED***les.
	CacheSizeBytes int
}
...
func NewLevelDB(o LevelDBOptions) (KeyValueStore, error) {
	options := &leveldb_opt.Options{
		...
		Filter:             leveldb_***REMOVED***lter.NewBloomFilter(10),
	}
...
func (l *LevelDB) Delete(key encoding.BinaryMarshaler) (bool, error) {
	...
	// for existence with Has ***REMOVED***rst.
