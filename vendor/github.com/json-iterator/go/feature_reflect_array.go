...
func decoderOfArray(cfg *frozenCon***REMOVED***g, typ reflect.Type) (ValDecoder, error) {
...
func encoderOfArray(cfg *frozenCon***REMOVED***g, typ reflect.Type) (ValEncoder, error) {
