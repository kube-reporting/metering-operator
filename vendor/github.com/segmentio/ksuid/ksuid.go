...
const (
	...
	// signi***REMOVED***cantly higher useful lifetime of around 136 years from March 2017.
...
// Get satis***REMOVED***es the flag.Getter interface, making it possible to use KSUIDs as
// part of of the command line options of a program.
func (i KSUID) Get() interface{} {
	return i
}

// Set satis***REMOVED***es the flag.Value interface, making it possible to use KSUIDs as
// part of of the command line options of a program.
