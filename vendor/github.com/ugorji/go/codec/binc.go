...
func (e *bincEncDriver) EncodeSymbol(v string) {
	...
	//symbols only offer bene***REMOVED***t when string length > 1.
	...
	if ok {
		...
		if l <= math.MaxUint8 {
			// lenprec = 0
		} ***REMOVED*** if l <= math.MaxUint16 {
			lenprec = 1
		} ***REMOVED*** if int64(l) <= math.MaxUint32 {
			lenprec = 2
		} ***REMOVED*** {
			lenprec = 3
		}
...
func (d *bincDecDriver) ContainerType() (vt valueType) {
	if d.vd == bincVdSpecial && d.vs == bincSpNil {
		return valueTypeNil
	} ***REMOVED*** if d.vd == bincVdByteArray {
		return valueTypeBytes
	} ***REMOVED*** if d.vd == bincVdString {
		return valueTypeString
	} ***REMOVED*** if d.vd == bincVdArray {
		return valueTypeArray
	} ***REMOVED*** if d.vd == bincVdMap {
		return valueTypeMap
	} ***REMOVED*** {
...
func (d *bincDecDriver) decCheckInteger() (ui uint64, neg bool) {
	...
	if vd == bincVdPosInt {
		ui = d.decUint()
	} ***REMOVED*** if vd == bincVdNegInt {
		ui = d.decUint()
		neg = true
	} ***REMOVED*** if vd == bincVdSmallInt {
		ui = uint64(d.vs) + 1
	} ***REMOVED*** if vd == bincVdSpecial {
		if vs == bincSpZero {
			//i = 0
		} ***REMOVED*** if vs == bincSpNegOne {
			neg = true
			ui = 1
		} ***REMOVED*** {
...
func (d *bincDecDriver) DecodeFloat(chkOverflow32 bool) (f float64) {
	...
	if vd == bincVdSpecial {
		...
		if vs == bincSpNan {
			return math.NaN()
		} ***REMOVED*** if vs == bincSpPosInf {
			return math.Inf(1)
		} ***REMOVED*** if vs == bincSpZeroFloat || vs == bincSpZero {
			return
		} ***REMOVED*** if vs == bincSpNegInf {
			return math.Inf(-1)
		} ***REMOVED*** {
			d.d.errorf("Invalid d.vs decoding float where d.vd=bincVdSpecial: %v", d.vs)
			return
		}
	} ***REMOVED*** if vd == bincVdFloat {
		f = d.decFloat()
	} ***REMOVED*** {
...
func (d *bincDecDriver) DecodeBool() (b bool) {
	...
	if bd := d.bd; bd == (bincVdSpecial | bincSpFalse) {
		// b = false
	} ***REMOVED*** if bd == (bincVdSpecial | bincSpTrue) {
		b = true
	} ***REMOVED*** {
...
func (d *bincDecDriver) decStringAndBytes(bs []byte, withString, zerocopy bool) (bs2 []byte, s string) {
	...
	case bincVdSymbol:
		...
		//***REMOVED*** look in map for string value
		var symbol uint16
		vs := d.vs
		if vs&0x8 == 0 {
...
//de***REMOVED***ned at https://github.com/ugorji/binc .
//
