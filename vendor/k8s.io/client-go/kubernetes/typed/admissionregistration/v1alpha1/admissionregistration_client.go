...
func (c *AdmissionregistrationV1alpha1Client) InitializerCon***REMOVED***gurations() InitializerCon***REMOVED***gurationInterface {
	return newInitializerCon***REMOVED***gurations(c)
}

// NewForCon***REMOVED***g creates a new AdmissionregistrationV1alpha1Client for the given con***REMOVED***g.
func NewForCon***REMOVED***g(c *rest.Con***REMOVED***g) (*AdmissionregistrationV1alpha1Client, error) {
	con***REMOVED***g := *c
...
// NewForCon***REMOVED***gOrDie creates a new AdmissionregistrationV1alpha1Client for the given con***REMOVED***g and
// panics if there is an error in the con***REMOVED***g.
func NewForCon***REMOVED***gOrDie(c *rest.Con***REMOVED***g) *AdmissionregistrationV1alpha1Client {
