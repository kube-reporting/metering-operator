...
// CronSpec de***REMOVED***nes which report should be run and when.
type CronSpec struct {
	// Schedule is de***REMOVED***ned using a CRON expression. Details at https://en.wikipedia.org/wiki/Cron.
