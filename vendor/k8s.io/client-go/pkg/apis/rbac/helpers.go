...
func NonResourceURLMatches(rule *PolicyRule, requestedURL string) bool {
	for _, ruleURL := range rule.NonResourceURLs {
		...
		if strings.HasSuf***REMOVED***x(ruleURL, "*") && strings.HasPre***REMOVED***x(requestedURL, strings.TrimRight(ruleURL, "*")) {
			return true
		}
	}
...
// to de***REMOVED***ne the subjects of a role binding. At least one of
...
// Groups adds the speci***REMOVED***ed groups as the subjects of the RoleBinding.
...
// Users adds the speci***REMOVED***ed users as the subjects of the RoleBinding.
...
// SAs adds the speci***REMOVED***ed service accounts as the subjects of the
// RoleBinding.
