...
: "${INSTALLER_MANIFESTS_DIR:=$DEPLOY_MANIFESTS_DIR/$METERING_VERSION/$DEPLOY_PLATFORM/helm-operator}"
: "${ALM_MANIFESTS_DIR:=$MANIFESTS_DIR/deploy/$METERING_VERSION/$DEPLOY_PLATFORM/alm}"
