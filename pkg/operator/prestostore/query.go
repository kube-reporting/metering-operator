...
func ImportFromTimeRange(logger logrus.FieldLogger, clock clock.Clock, promConn prom.API, prestoQueryer db.Queryer, metricsCollectors ImporterMetricsCollectors, ctx context.Context, startTime, endTime time.Time, cfg Con***REMOVED***g, allowIncompleteChunks bool) (PrometheusImportResults, error) {
