...
func PackageForGroup(gv clientgentypes.GroupVersion, typeList []*types.Type, clientsetPackage string, inputPackage string, boilerplate []byte, generatedBy string) generator.Package {
	outputPackage := strings.ToLower(***REMOVED***lepath.Join(clientsetPackage, "typed", gv.Group.NonEmpty(), gv.Version.NonEmpty(), "fake"))
	// TODO: should make this a function, called by here and in client-generator.go
	realClientPackage := ***REMOVED***lepath.Join(clientsetPackage, "typed", gv.Group.NonEmpty(), gv.Version.NonEmpty())
...
func PackageForClientset(customArgs clientgenargs.Args, fakeClientsetPackage string, boilerplate []byte, generatedBy string) generator.Package {
	return &generator.DefaultPackage{
		...
		PackageName: "fake",
		PackagePath: ***REMOVED***lepath.Join(fakeClientsetPackage, "fake"),
		HeaderText:  boilerplate,
		PackageDocumentation: []byte(
			generatedBy +
		...
		GeneratorFunc: func(c *generator.Context) (generators []generator.Generator) {
			generators = []generator.Generator{
				...
				&genClientset{
					...
					outputPackage:        "fake",
					imports:              generator.NewImportTracker(),
					realClientsetPackage: ***REMOVED***lepath.Join(customArgs.ClientsetOutputPath, customArgs.ClientsetName),
				},
				&scheme.GenScheme{
					DefaultGen: generator.DefaultGen{
