...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&Con***REMOVED***gMap{}, func(obj interface{}) { SetObjectDefaults_Con***REMOVED***gMap(obj.(*Con***REMOVED***gMap)) })
	scheme.AddTypeDefaultingFunc(&Con***REMOVED***gMapList{}, func(obj interface{}) { SetObjectDefaults_Con***REMOVED***gMapList(obj.(*Con***REMOVED***gMapList)) })
...
func SetObjectDefaults_Con***REMOVED***gMap(in *Con***REMOVED***gMap) {
	SetDefaults_Con***REMOVED***gMap(in)
}

func SetObjectDefaults_Con***REMOVED***gMapList(in *Con***REMOVED***gMapList) {
	for i := range in.Items {
		a := &in.Items[i]
		SetObjectDefaults_Con***REMOVED***gMap(a)
	}
}
...
func SetObjectDefaults_Pod(in *Pod) {
	...
	for i := range in.Spec.Volumes {
		...
		if a.VolumeSource.Con***REMOVED***gMap != nil {
			SetDefaults_Con***REMOVED***gMapVolumeSource(a.VolumeSource.Con***REMOVED***gMap)
		}
