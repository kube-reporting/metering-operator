...
type Clientset struct {
	...
	*certi***REMOVED***catesv1beta1.Certi***REMOVED***catesV1beta1Client
	*corev1.CoreV1Client
...
func (c *Clientset) Certi***REMOVED***catesV1beta1() certi***REMOVED***catesv1beta1.Certi***REMOVED***catesV1beta1Interface {
	...
	return c.Certi***REMOVED***catesV1beta1Client
}
...
func NewForCon***REMOVED***g(c *rest.Con***REMOVED***g) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.AdmissionregistrationV1alpha1Client, err = admissionregistrationv1alpha1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AppsV1beta1Client, err = appsv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AuthenticationV1Client, err = authenticationv1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AuthenticationV1beta1Client, err = authenticationv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AuthorizationV1Client, err = authorizationv1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AuthorizationV1beta1Client, err = authorizationv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AutoscalingV1Client, err = autoscalingv1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.AutoscalingV2alpha1Client, err = autoscalingv2alpha1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.BatchV1Client, err = batchv1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.BatchV2alpha1Client, err = batchv2alpha1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.Certi***REMOVED***catesV1beta1Client, err = certi***REMOVED***catesv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.CoreV1Client, err = corev1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.ExtensionsV1beta1Client, err = extensionsv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.NetworkingV1Client, err = networkingv1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.PolicyV1beta1Client, err = policyv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.RbacV1beta1Client, err = rbacv1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.RbacV1alpha1Client, err = rbacv1alpha1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.SettingsV1alpha1Client, err = settingsv1alpha1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.StorageV1beta1Client, err = storagev1beta1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
	cs.StorageV1Client, err = storagev1.NewForCon***REMOVED***g(&con***REMOVED***gShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForCon***REMOVED***gOrDie(c *rest.Con***REMOVED***g) *Clientset {
	var cs Clientset
	cs.AdmissionregistrationV1alpha1Client = admissionregistrationv1alpha1.NewForCon***REMOVED***gOrDie(c)
	cs.AppsV1beta1Client = appsv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.AuthenticationV1Client = authenticationv1.NewForCon***REMOVED***gOrDie(c)
	cs.AuthenticationV1beta1Client = authenticationv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.AuthorizationV1Client = authorizationv1.NewForCon***REMOVED***gOrDie(c)
	cs.AuthorizationV1beta1Client = authorizationv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.AutoscalingV1Client = autoscalingv1.NewForCon***REMOVED***gOrDie(c)
	cs.AutoscalingV2alpha1Client = autoscalingv2alpha1.NewForCon***REMOVED***gOrDie(c)
	cs.BatchV1Client = batchv1.NewForCon***REMOVED***gOrDie(c)
	cs.BatchV2alpha1Client = batchv2alpha1.NewForCon***REMOVED***gOrDie(c)
	cs.Certi***REMOVED***catesV1beta1Client = certi***REMOVED***catesv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.CoreV1Client = corev1.NewForCon***REMOVED***gOrDie(c)
	cs.ExtensionsV1beta1Client = extensionsv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.NetworkingV1Client = networkingv1.NewForCon***REMOVED***gOrDie(c)
	cs.PolicyV1beta1Client = policyv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.RbacV1beta1Client = rbacv1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.RbacV1alpha1Client = rbacv1alpha1.NewForCon***REMOVED***gOrDie(c)
	cs.SettingsV1alpha1Client = settingsv1alpha1.NewForCon***REMOVED***gOrDie(c)
	cs.StorageV1beta1Client = storagev1beta1.NewForCon***REMOVED***gOrDie(c)
	cs.StorageV1Client = storagev1.NewForCon***REMOVED***gOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.Certi***REMOVED***catesV1beta1Client = certi***REMOVED***catesv1beta1.New(c)
