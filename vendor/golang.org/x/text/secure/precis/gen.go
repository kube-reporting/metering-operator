...
var outputFile = flag.String("output", "tables.go", "output ***REMOVED***le for generated tables; default tables.go")
...
var overrides = map[category]category{
	viramaModi***REMOVED***er: viramaJoinT,
	greek:          greekJoinT,
	hebrew:         hebrewJoinT,
}
...
func main() {
	...
	ucd.Parse(gen.OpenUCDFile("UnicodeData.txt"), func(p *ucd.Parser) {
		...
		if p.Int(ucd.CanonicalCombiningClass) == cccVirama {
			setCategory(p.Rune(0), viramaModi***REMOVED***er)
		}
	})
...
// The Exceptions class as de***REMOVED***ned in RFC 5892
...
var exceptions = map[rune]exception{
	...
	// These are of***REMOVED***cially ContextO, but the implementation does not require
...
func isLetterDigits(r rune) bool {
	return unicode.In(r,
		...
		unicode.Mn, unicode.Mc, // Modi***REMOVED***ers
		unicode.Nd, // Digits
	)
}
