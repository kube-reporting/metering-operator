...
func (e *simpleEncDriver) encLen(bd byte, length int) {
	if length == 0 {
		e.w.writen1(bd)
	} ***REMOVED*** if length <= math.MaxUint8 {
		e.w.writen1(bd + 1)
		e.w.writen1(uint8(length))
	} ***REMOVED*** if length <= math.MaxUint16 {
		e.w.writen1(bd + 2)
		bigenHelper{e.b[:2], e.w}.writeUint16(uint16(length))
	} ***REMOVED*** if int64(length) <= math.MaxUint32 {
		e.w.writen1(bd + 3)
...
func (d *simpleDecDriver) DecodeFloat(chkOverflow32 bool) (f float64) {
	...
	} ***REMOVED*** if d.bd == simpleVdFloat64 {
