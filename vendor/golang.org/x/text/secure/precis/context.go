...
// This ***REMOVED***le contains tables and code related to context rules.
...
var categoryTransitions = []struct {
	...
	accept catBitmap // bits that pass, but not suf***REMOVED***cient as termination

	// The rule function cannot take a *context as an argument, as it would
	// cause the context to escape, adding signi***REMOVED***cant overhead.
	...
	viramaModi***REMOVED***er:    {set: bVirama},
