...
func PackageForGroup(gv clientgentypes.GroupVersion, typeList []*types.Type, clientsetPackage string, groupPackageName string, groupGoName string, inputPackage string, boilerplate []byte) generator.Package {
	outputPackage := strings.ToLower(***REMOVED***lepath.Join(clientsetPackage, "typed", groupPackageName, gv.Version.NonEmpty(), "fake"))
	// TODO: should make this a function, called by here and in client-generator.go
	realClientPackage := ***REMOVED***lepath.Join(clientsetPackage, "typed", groupPackageName, gv.Version.NonEmpty())
