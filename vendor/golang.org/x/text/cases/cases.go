...
// Package cases provides general and language-speci***REMOVED***c case mappers.
...
// Upper returns a Caser for language-speci***REMOVED***c uppercasing.
func Upper(t language.Tag, opts ...Option) Caser {
	return Caser{makeUpper(t, getOpts(opts...))}
}

// Lower returns a Caser for language-speci***REMOVED***c lowercasing.
func Lower(t language.Tag, opts ...Option) Caser {
	return Caser{makeLower(t, getOpts(opts...))}
}

// Title returns a Caser for language-speci***REMOVED***c title casing. It uses an
...
// algorithm could set different defaults by pre***REMOVED***xing a user-provided slice
// of options with their own. This is handy, for instance, for the precis
// package which would override the default to not handle the Greek ***REMOVED***nal sigma.
...
// HandleFinalSigma speci***REMOVED***es whether the special handling of Greek ***REMOVED***nal sigma
// should be enabled. Unicode prescribes handling the Greek ***REMOVED***nal sigma for all
