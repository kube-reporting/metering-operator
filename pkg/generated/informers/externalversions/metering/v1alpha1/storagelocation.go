	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MeteringV1alpha1().StorageLocations(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeteringV1alpha1().StorageLocations(namespace).Watch(options)
			},
		},
		&metering_v1alpha1.StorageLocation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageLocationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&metering_v1alpha1.StorageLocation{}, f.defaultInformer)
}
