...
var map_CronJobSpec = map[string]string{
	...
	"successfulJobsHistoryLimit": "The number of successful ***REMOVED***nished jobs to retain. This is a pointer to distinguish between explicit zero and not speci***REMOVED***ed. Defaults to 3.",
	"failedJobsHistoryLimit":     "The number of failed ***REMOVED***nished jobs to retain. This is a pointer to distinguish between explicit zero and not speci***REMOVED***ed. Defaults to 1.",
}
