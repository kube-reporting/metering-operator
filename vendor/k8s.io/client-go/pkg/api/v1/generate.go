...
type NameGenerator interface {
	// GenerateName generates a valid name from the base name, adding a random suf***REMOVED***x to the
...
// SimpleNameGenerator is a generator that returns the name plus a random suf***REMOVED***x of ***REMOVED***ve alphanumerics
