...
# contributor license agreements.  See the NOTICE ***REMOVED***le distributed with
# this work for additional information regarding copyright ownership.
# The ASF licenses this ***REMOVED***le to You under the Apache License, Version 2.0
# (the "License"); you may not use this ***REMOVED***le except in compliance with
