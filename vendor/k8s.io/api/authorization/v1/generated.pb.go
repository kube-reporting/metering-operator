...
func (*ResourceAttributes) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{3} }

func (m *SelfSubjectAccessReview) Reset()                    { *m = SelfSubjectAccessReview{} }
func (*SelfSubjectAccessReview) ProtoMessage()               {}
func (*SelfSubjectAccessReview) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{4} }
...
func (*SubjectAccessReview) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{6} }

func (m *SubjectAccessReviewSpec) Reset()                    { *m = SubjectAccessReviewSpec{} }
func (*SubjectAccessReviewSpec) ProtoMessage()               {}
func (*SubjectAccessReviewSpec) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{7} }
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/authorization/v1/generated.proto", ***REMOVED***leDescriptorGenerated)
}
