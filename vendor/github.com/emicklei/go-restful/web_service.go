...
// and model de***REMOVED***nitions. If not set, the web service will invoke
...
// returns the name that Go identi***REMOVED***es it with (e.g. "string" or "v1.Object") via
// the reflection API.
...
// Path speci***REMOVED***es the root URL template path of the WebService.
...
// RemoveRoute removes the speci***REMOVED***ed route, looks for something that matches 'path' and 'method'
...
// Produces speci***REMOVED***es that this WebService can produce one or more MIME types.
...
// Consumes speci***REMOVED***es that this WebService can consume one or more MIME types.
...
// Filter adds a ***REMOVED***lter function to the chain of ***REMOVED***lters applicable to all its Routes
func (w *WebService) Filter(***REMOVED***lter FilterFunction) *WebService {
	w.***REMOVED***lters = append(w.***REMOVED***lters, ***REMOVED***lter)
	return w
}
