...
type RecognizingDecoder interface {
	...
	// provides) and may return unknown if the data provided is not suf***REMOVED***cient to make a
...
// NewDecoder creates a decoder that will attempt multiple decoders in an order de***REMOVED***ned
// by:
//
// 1. The decoder implements RecognizingDecoder and identi***REMOVED***es the data
...
func (d *decoder) RecognizesData(peek io.Reader) (bool, bool, error) {
	...
	data, _ := bu***REMOVED***o.NewReaderSize(peek, 1024).Peek(1024)
