...
var map_DeleteOptions = map[string]string{
	...
	"PropagationPolicy":  "Whether and how garbage collection will be performed. Either this ***REMOVED***eld or OrphanDependents may be set, but not both. The default policy is decided by the existing ***REMOVED***nalizer set in the metadata.***REMOVED***nalizers and the resource-speci***REMOVED***c default policy.",
}
...
var map_NamespaceSpec = map[string]string{
	...
	"***REMOVED***nalizers": "Finalizers is an opaque list of values that must be empty to permanently remove object from storage. More info: https://git.k8s.io/community/contributors/design-proposals/namespaces.md#***REMOVED***nalizers",
}
...
var map_PodAf***REMOVED***nityTerm = map[string]string{
	...
	"topologyKey":   "This pod should be co-located (af***REMOVED***nity) or not co-located (anti-af***REMOVED***nity) with the pods matching the labelSelector in the speci***REMOVED***ed namespaces, where co-located is de***REMOVED***ned as running on a node whose value of the label with key topologyKey matches that of any node on which any of the selected pods is running. For PreferredDuringScheduling pod anti-af***REMOVED***nity, empty topologyKey is interpreted as \"all topologies\" (\"all topologies\" here means all the topologyKeys indicated by scheduler command-line argument --failure-domains); for af***REMOVED***nity and for RequiredDuringScheduling pod anti-af***REMOVED***nity, empty topologyKey is not allowed.",
}
...
var map_ScaleIOVolumeSource = map[string]string{
	...
	"protectionDomain": "The name of the Protection Domain for the con***REMOVED***gured storage (defaults to \"default\").",
