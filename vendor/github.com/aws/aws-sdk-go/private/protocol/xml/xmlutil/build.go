...
// buildStruct adds a struct and its ***REMOVED***elds to the current XMLNode. All ***REMOVED***elds any any nested
...
func (b *xmlBuilder) buildStruct(value reflect.Value, current *XMLNode, tag reflect.StructTag) error {
	...
	***REMOVED***eldAdded := false
	...
	for i := 0; i < value.NumField(); i++ {
		...
		***REMOVED***eldAdded = true
	}

	if ***REMOVED***eldAdded { // only append this child if we have one ore more valid members
