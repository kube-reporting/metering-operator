...
// described in OAuth2 Con***REMOVED***gs, above. The TokenSource in the returned value is the
// same as the one obtained from the oauth2.Con***REMOVED***g returned from Con***REMOVED***gFromJSON or
// JWTCon***REMOVED***gFromJSON, but the Credentials may contain additional information
