...
var map_TableRow = map[string]string{
	...
	"cells":      "cells will be as wide as headers and may contain strings, numbers, booleans, simple maps, or lists, or null. See the type ***REMOVED***eld of the column de***REMOVED***nition for a more detailed description.",
