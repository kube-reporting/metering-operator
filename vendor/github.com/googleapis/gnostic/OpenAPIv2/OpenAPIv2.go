...
func NewApiKeySecurity(in interface{}, context *compiler.Context) (*ApiKeySecurity, error) {
	...
	if !ok {
		...
		for _, item := range m {
			...
			if ok {
				v := item.Value
				if strings.HasPre***REMOVED***x(k, "x-") {
					pair := &NamedAny{}
					pair.Name = k
					result := &Any{}
...
// NewDe***REMOVED***nitions creates an object of type De***REMOVED***nitions if possible, returning an error if not.
func NewDe***REMOVED***nitions(in interface{}, context *compiler.Context) (*De***REMOVED***nitions, error) {
	errors := make([]error, 0)
	x := &De***REMOVED***nitions{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
		message := fmt.Sprintf("has unexpected value: %+v (%T)", in, in)
		errors = append(errors, compiler.NewError(context, message))
...
func NewDocument(in interface{}, context *compiler.Context) (*Document, error) {
	...
	if !ok {
		...
		allowedKeys := []string{"basePath", "consumes", "de***REMOVED***nitions", "externalDocs", "host", "info", "parameters", "paths", "produces", "responses", "schemes", "security", "securityDe***REMOVED***nitions", "swagger", "tags"}
		allowedPatterns := []*regexp.Regexp{pattern0}
		invalidKeys := compiler.InvalidKeysInMap(m, allowedKeys, allowedPatterns)
		if len(invalidKeys) > 0 {
			message := fmt.Sprintf("has invalid %s: %+v", compiler.PluralProperties(len(invalidKeys)), strings.Join(invalidKeys, ", "))
		...
		// De***REMOVED***nitions de***REMOVED***nitions = 9;
		v9 := compiler.MapValueForKey(m, "de***REMOVED***nitions")
		if v9 != nil {
			var err error
			x.De***REMOVED***nitions, err = NewDe***REMOVED***nitions(v9, compiler.NewContext("de***REMOVED***nitions", context))
			if err != nil {
				errors = append(errors, err)
			}
		}
		// ParameterDe***REMOVED***nitions parameters = 10;
		v10 := compiler.MapValueForKey(m, "parameters")
		if v10 != nil {
			var err error
			x.Parameters, err = NewParameterDe***REMOVED***nitions(v10, compiler.NewContext("parameters", context))
			if err != nil {
				errors = append(errors, err)
			}
		}
		// ResponseDe***REMOVED***nitions responses = 11;
		v11 := compiler.MapValueForKey(m, "responses")
		if v11 != nil {
			var err error
			x.Responses, err = NewResponseDe***REMOVED***nitions(v11, compiler.NewContext("responses", context))
			if err != nil {
				errors = append(errors, err)
			}
		}
		...
		// SecurityDe***REMOVED***nitions security_de***REMOVED***nitions = 13;
		v13 := compiler.MapValueForKey(m, "securityDe***REMOVED***nitions")
		if v13 != nil {
			var err error
			x.SecurityDe***REMOVED***nitions, err = NewSecurityDe***REMOVED***nitions(v13, compiler.NewContext("securityDe***REMOVED***nitions", context))
			if err != nil {
				errors = append(errors, err)
			}
		}
...
func NewFileSchema(in interface{}, context *compiler.Context) (*FileSchema, error) {
	...
	if !ok {
		...
		if v6 != nil {
			...
			// check for valid enum values
			// [***REMOVED***le]
			if ok && !compiler.StringArrayContainsValue([]string{"***REMOVED***le"}, x.Type) {
				message := fmt.Sprintf("has unexpected value for type: %+v (%T)", v6, v6)
				errors = append(errors, compiler.NewError(context, message))
			}
		}
...
func NewFormDataParameterSubSchema(in interface{}, context *compiler.Context) (*FormDataParameterSubSchema, error) {
	...
	if !ok {
		...
		if v6 != nil {
			...
			// check for valid enum values
			// [string number boolean integer array ***REMOVED***le]
			if ok && !compiler.StringArrayContainsValue([]string{"string", "number", "boolean", "integer", "array", "***REMOVED***le"}, x.Type) {
				message := fmt.Sprintf("has unexpected value for type: %+v (%T)", v6, v6)
				errors = append(errors, compiler.NewError(context, message))
			}
		}
...
// NewNamedSecurityDe***REMOVED***nitionsItem creates an object of type NamedSecurityDe***REMOVED***nitionsItem if possible, returning an error if not.
func NewNamedSecurityDe***REMOVED***nitionsItem(in interface{}, context *compiler.Context) (*NamedSecurityDe***REMOVED***nitionsItem, error) {
	errors := make([]error, 0)
	x := &NamedSecurityDe***REMOVED***nitionsItem{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
		message := fmt.Sprintf("has unexpected value: %+v (%T)", in, in)
		errors = append(errors, compiler.NewError(context, message))
		...
		// SecurityDe***REMOVED***nitionsItem value = 2;
		v2 := compiler.MapValueForKey(m, "value")
		if v2 != nil {
			var err error
			x.Value, err = NewSecurityDe***REMOVED***nitionsItem(v2, compiler.NewContext("value", context))
			if err != nil {
				errors = append(errors, err)
			}
		}
...
// NewParameterDe***REMOVED***nitions creates an object of type ParameterDe***REMOVED***nitions if possible, returning an error if not.
func NewParameterDe***REMOVED***nitions(in interface{}, context *compiler.Context) (*ParameterDe***REMOVED***nitions, error) {
	errors := make([]error, 0)
	x := &ParameterDe***REMOVED***nitions{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
		message := fmt.Sprintf("has unexpected value: %+v (%T)", in, in)
		errors = append(errors, compiler.NewError(context, message))
...
// NewResponseDe***REMOVED***nitions creates an object of type ResponseDe***REMOVED***nitions if possible, returning an error if not.
func NewResponseDe***REMOVED***nitions(in interface{}, context *compiler.Context) (*ResponseDe***REMOVED***nitions, error) {
	errors := make([]error, 0)
	x := &ResponseDe***REMOVED***nitions{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
		message := fmt.Sprintf("has unexpected value: %+v (%T)", in, in)
		errors = append(errors, compiler.NewError(context, message))
...
func NewSchemaItem(in interface{}, context *compiler.Context) (*SchemaItem, error) {
	...
	// FileSchema ***REMOVED***le_schema = 2;
	{
		m, ok := compiler.UnpackMap(in)
		if ok {
			// errors might be ok here, they mean we just don't have the right subtype
			t, matchingError := NewFileSchema(m, compiler.NewContext("***REMOVED***leSchema", context))
			if matchingError == nil {
...
// NewSecurityDe***REMOVED***nitions creates an object of type SecurityDe***REMOVED***nitions if possible, returning an error if not.
func NewSecurityDe***REMOVED***nitions(in interface{}, context *compiler.Context) (*SecurityDe***REMOVED***nitions, error) {
	errors := make([]error, 0)
	x := &SecurityDe***REMOVED***nitions{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
		message := fmt.Sprintf("has unexpected value: %+v (%T)", in, in)
		errors = append(errors, compiler.NewError(context, message))
	} ***REMOVED*** {
		// repeated NamedSecurityDe***REMOVED***nitionsItem additional_properties = 1;
		// MAP: SecurityDe***REMOVED***nitionsItem
		x.AdditionalProperties = make([]*NamedSecurityDe***REMOVED***nitionsItem, 0)
		for _, item := range m {
			k, ok := compiler.StringValue(item.Key)
			if ok {
				v := item.Value
				pair := &NamedSecurityDe***REMOVED***nitionsItem{}
				pair.Name = k
				var err error
				pair.Value, err = NewSecurityDe***REMOVED***nitionsItem(v, compiler.NewContext(k, context))
				if err != nil {
					errors = append(errors, err)
				}
				x.AdditionalProperties = append(x.AdditionalProperties, pair)
...
// NewSecurityDe***REMOVED***nitionsItem creates an object of type SecurityDe***REMOVED***nitionsItem if possible, returning an error if not.
func NewSecurityDe***REMOVED***nitionsItem(in interface{}, context *compiler.Context) (*SecurityDe***REMOVED***nitionsItem, error) {
	errors := make([]error, 0)
	x := &SecurityDe***REMOVED***nitionsItem{}
	matched := false
	// BasicAuthenticationSecurity basic_authentication_security = 1;
	{
		...
		if ok {
			...
			if matchingError == nil {
				x.Oneof = &SecurityDe***REMOVED***nitionsItem_BasicAuthenticationSecurity{BasicAuthenticationSecurity: t}
				matched = true
			} ***REMOVED*** {
				errors = append(errors, matchingError)
			}
	...
	// ApiKeySecurity api_key_security = 2;
	{
		...
		if ok {
			...
			if matchingError == nil {
				x.Oneof = &SecurityDe***REMOVED***nitionsItem_ApiKeySecurity{ApiKeySecurity: t}
				matched = true
			} ***REMOVED*** {
				errors = append(errors, matchingError)
			}
	...
	// Oauth2ImplicitSecurity oauth2_implicit_security = 3;
	{
		...
		if ok {
			...
			if matchingError == nil {
				x.Oneof = &SecurityDe***REMOVED***nitionsItem_Oauth2ImplicitSecurity{Oauth2ImplicitSecurity: t}
				matched = true
			} ***REMOVED*** {
				errors = append(errors, matchingError)
			}
	...
	// Oauth2PasswordSecurity oauth2_password_security = 4;
	{
		...
		if ok {
			...
			if matchingError == nil {
				x.Oneof = &SecurityDe***REMOVED***nitionsItem_Oauth2PasswordSecurity{Oauth2PasswordSecurity: t}
				matched = true
			} ***REMOVED*** {
				errors = append(errors, matchingError)
			}
	...
	// Oauth2ApplicationSecurity oauth2_application_security = 5;
	{
		...
		if ok {
			...
			if matchingError == nil {
				x.Oneof = &SecurityDe***REMOVED***nitionsItem_Oauth2ApplicationSecurity{Oauth2ApplicationSecurity: t}
				matched = true
			} ***REMOVED*** {
				errors = append(errors, matchingError)
			}
	...
	// Oauth2AccessCodeSecurity oauth2_access_code_security = 6;
	{
		...
		if ok {
			...
			if matchingError == nil {
				x.Oneof = &SecurityDe***REMOVED***nitionsItem_Oauth2AccessCodeSecurity{Oauth2AccessCodeSecurity: t}
				matched = true
			} ***REMOVED*** {
				errors = append(errors, matchingError)
			}
...
func NewXml(in interface{}, context *compiler.Context) (*Xml, error) {
	...
	if !ok {
		...
		allowedKeys := []string{"attribute", "name", "namespace", "pre***REMOVED***x", "wrapped"}
		allowedPatterns := []*regexp.Regexp{pattern0}
		invalidKeys := compiler.InvalidKeysInMap(m, allowedKeys, allowedPatterns)
		if len(invalidKeys) > 0 {
			message := fmt.Sprintf("has invalid %s: %+v", compiler.PluralProperties(len(invalidKeys)), strings.Join(invalidKeys, ", "))
		...
		// string pre***REMOVED***x = 3;
		v3 := compiler.MapValueForKey(m, "pre***REMOVED***x")
		if v3 != nil {
			x.Pre***REMOVED***x, ok = v3.(string)
			if !ok {
				message := fmt.Sprintf("has unexpected value for pre***REMOVED***x: %+v (%T)", v3, v3)
				errors = append(errors, compiler.NewError(context, message))
			}
		}
		// bool attribute = 4;
...
// ResolveReferences resolves references found inside De***REMOVED***nitions objects.
func (m *De***REMOVED***nitions) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	for _, item := range m.AdditionalProperties {
		if item != nil {
			_, err := item.ResolveReferences(root)
...
func (m *Document) ResolveReferences(root string) (interface{}, error) {
	...
	if m.De***REMOVED***nitions != nil {
		_, err := m.De***REMOVED***nitions.ResolveReferences(root)
		if err != nil {
			errors = append(errors, err)
		}
	}
	...
	if m.SecurityDe***REMOVED***nitions != nil {
		_, err := m.SecurityDe***REMOVED***nitions.ResolveReferences(root)
		if err != nil {
			errors = append(errors, err)
		}
	}
...
// ResolveReferences resolves references found inside NamedSecurityDe***REMOVED***nitionsItem objects.
func (m *NamedSecurityDe***REMOVED***nitionsItem) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	if m.Value != nil {
		_, err := m.Value.ResolveReferences(root)
		if err != nil {
...
// ResolveReferences resolves references found inside ParameterDe***REMOVED***nitions objects.
func (m *ParameterDe***REMOVED***nitions) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	for _, item := range m.AdditionalProperties {
		if item != nil {
			_, err := item.ResolveReferences(root)
...
// ResolveReferences resolves references found inside ResponseDe***REMOVED***nitions objects.
func (m *ResponseDe***REMOVED***nitions) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	for _, item := range m.AdditionalProperties {
		if item != nil {
			_, err := item.ResolveReferences(root)
...
// ResolveReferences resolves references found inside SecurityDe***REMOVED***nitions objects.
func (m *SecurityDe***REMOVED***nitions) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	for _, item := range m.AdditionalProperties {
		if item != nil {
			_, err := item.ResolveReferences(root)
...
// ResolveReferences resolves references found inside SecurityDe***REMOVED***nitionsItem objects.
func (m *SecurityDe***REMOVED***nitionsItem) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	{
		p, ok := m.Oneof.(*SecurityDe***REMOVED***nitionsItem_BasicAuthenticationSecurity)
		if ok {
	...
	{
		p, ok := m.Oneof.(*SecurityDe***REMOVED***nitionsItem_ApiKeySecurity)
		if ok {
	...
	{
		p, ok := m.Oneof.(*SecurityDe***REMOVED***nitionsItem_Oauth2ImplicitSecurity)
		if ok {
	...
	{
		p, ok := m.Oneof.(*SecurityDe***REMOVED***nitionsItem_Oauth2PasswordSecurity)
		if ok {
	...
	{
		p, ok := m.Oneof.(*SecurityDe***REMOVED***nitionsItem_Oauth2ApplicationSecurity)
		if ok {
	...
	{
		p, ok := m.Oneof.(*SecurityDe***REMOVED***nitionsItem_Oauth2AccessCodeSecurity)
		if ok {
...
// ToRawInfo returns a description of De***REMOVED***nitions suitable for JSON or YAML export.
func (m *De***REMOVED***nitions) ToRawInfo() interface{} {
	info := yaml.MapSlice{}
	if m.AdditionalProperties != nil {
		for _, item := range m.AdditionalProperties {
			info = append(info, yaml.MapItem{item.Name, item.Value.ToRawInfo()})
...
func (m *Document) ToRawInfo() interface{} {
	...
	if m.De***REMOVED***nitions != nil {
		info = append(info, yaml.MapItem{"de***REMOVED***nitions", m.De***REMOVED***nitions.ToRawInfo()})
	}
	// &{Name:de***REMOVED***nitions Type:De***REMOVED***nitions StringEnumValues:[] MapType: Repeated:false Pattern: Implicit:false Description:}
	if m.Parameters != nil {
		info = append(info, yaml.MapItem{"parameters", m.Parameters.ToRawInfo()})
	}
	// &{Name:parameters Type:ParameterDe***REMOVED***nitions StringEnumValues:[] MapType: Repeated:false Pattern: Implicit:false Description:}
	if m.Responses != nil {
		info = append(info, yaml.MapItem{"responses", m.Responses.ToRawInfo()})
	}
	// &{Name:responses Type:ResponseDe***REMOVED***nitions StringEnumValues:[] MapType: Repeated:false Pattern: Implicit:false Description:}
	if len(m.Security) != 0 {
	...
	if m.SecurityDe***REMOVED***nitions != nil {
		info = append(info, yaml.MapItem{"securityDe***REMOVED***nitions", m.SecurityDe***REMOVED***nitions.ToRawInfo()})
	}
	// &{Name:securityDe***REMOVED***nitions Type:SecurityDe***REMOVED***nitions StringEnumValues:[] MapType: Repeated:false Pattern: Implicit:false Description:}
	if len(m.Tags) != 0 {
		items := make([]interface{}, 0)
		for _, item := range m.Tags {
			items = append(items, item.ToRawInfo())
...
// ToRawInfo returns a description of NamedSecurityDe***REMOVED***nitionsItem suitable for JSON or YAML export.
func (m *NamedSecurityDe***REMOVED***nitionsItem) ToRawInfo() interface{} {
	info := yaml.MapSlice{}
	if m.Name != "" {
		info = append(info, yaml.MapItem{"name", m.Name})
	}
	// &{Name:value Type:SecurityDe***REMOVED***nitionsItem StringEnumValues:[] MapType: Repeated:false Pattern: Implicit:false Description:Mapped value}
	return info
}
...
// ToRawInfo returns a description of ParameterDe***REMOVED***nitions suitable for JSON or YAML export.
func (m *ParameterDe***REMOVED***nitions) ToRawInfo() interface{} {
	info := yaml.MapSlice{}
	if m.AdditionalProperties != nil {
		for _, item := range m.AdditionalProperties {
			info = append(info, yaml.MapItem{item.Name, item.Value.ToRawInfo()})
...
// ToRawInfo returns a description of ResponseDe***REMOVED***nitions suitable for JSON or YAML export.
func (m *ResponseDe***REMOVED***nitions) ToRawInfo() interface{} {
	info := yaml.MapSlice{}
	if m.AdditionalProperties != nil {
		for _, item := range m.AdditionalProperties {
			info = append(info, yaml.MapItem{item.Name, item.Value.ToRawInfo()})
...
func (m *SchemaItem) ToRawInfo() interface{} {
	...
	// {Name:***REMOVED***leSchema Type:FileSchema StringEnumValues:[] MapType: Repeated:false Pattern: Implicit:false Description:}
	v1 := m.GetFileSchema()
	if v1 != nil {
		return v1.ToRawInfo()
	}
...
// ToRawInfo returns a description of SecurityDe***REMOVED***nitions suitable for JSON or YAML export.
func (m *SecurityDe***REMOVED***nitions) ToRawInfo() interface{} {
	info := yaml.MapSlice{}
	if m.AdditionalProperties != nil {
		for _, item := range m.AdditionalProperties {
			info = append(info, yaml.MapItem{item.Name, item.Value.ToRawInfo()})
	...
	// &{Name:additionalProperties Type:NamedSecurityDe***REMOVED***nitionsItem StringEnumValues:[] MapType:SecurityDe***REMOVED***nitionsItem Repeated:true Pattern: Implicit:true Description:}
	return info
}

// ToRawInfo returns a description of SecurityDe***REMOVED***nitionsItem suitable for JSON or YAML export.
func (m *SecurityDe***REMOVED***nitionsItem) ToRawInfo() interface{} {
	// ONE OF WRAPPER
...
func (m *Xml) ToRawInfo() interface{} {
	...
	if m.Pre***REMOVED***x != "" {
		info = append(info, yaml.MapItem{"pre***REMOVED***x", m.Pre***REMOVED***x})
	}
