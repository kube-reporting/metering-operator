...
// The order of these constants matter. A Pro***REMOVED***le may consider runes to be
// allowed either from pValid or idDisOrFreePVal.
const (
	unassigned property = iota << propShift
	disallowed
	idDisOrFreePVal // disallowed for Identi***REMOVED***er, pValid for FreeForm
	pValid
)
...
const (
	...
	// Special rune types associated with contextual rules de***REMOVED***ned in
