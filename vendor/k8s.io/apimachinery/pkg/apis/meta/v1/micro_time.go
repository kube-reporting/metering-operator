...
// copy-by-assign, despite the presence of (unexported) Pointer ***REMOVED***elds.
...
func (_ MicroTime) OpenAPIDe***REMOVED***nition() openapi.OpenAPIDe***REMOVED***nition {
	return openapi.OpenAPIDe***REMOVED***nition{
		Schema: spec.Schema{
...
// Fuzz satis***REMOVED***es fuzz.Interface.
