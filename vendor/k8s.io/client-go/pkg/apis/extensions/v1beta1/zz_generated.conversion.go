...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_RollbackCon***REMOVED***g_To_extensions_RollbackCon***REMOVED***g,
		Convert_extensions_RollbackCon***REMOVED***g_To_v1beta1_RollbackCon***REMOVED***g,
...
func autoConvert_v1beta1_DeploymentRollback_To_extensions_DeploymentRollback(in *DeploymentRollback, out *extensions.DeploymentRollback, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_RollbackCon***REMOVED***g_To_extensions_RollbackCon***REMOVED***g(&in.RollbackTo, &out.RollbackTo, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_extensions_DeploymentRollback_To_v1beta1_DeploymentRollback(in *extensions.DeploymentRollback, out *DeploymentRollback, s conversion.Scope) error {
	out.Name = in.Name
	out.UpdatedAnnotations = *(*map[string]string)(unsafe.Pointer(&in.UpdatedAnnotations))
	if err := Convert_extensions_RollbackCon***REMOVED***g_To_v1beta1_RollbackCon***REMOVED***g(&in.RollbackTo, &out.RollbackTo, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_DeploymentSpec_To_extensions_DeploymentSpec(in *DeploymentSpec, out *extensions.DeploymentSpec, s conversion.Scope) error {
	...
	out.RollbackTo = (*extensions.RollbackCon***REMOVED***g)(unsafe.Pointer(in.RollbackTo))
...
func autoConvert_extensions_DeploymentSpec_To_v1beta1_DeploymentSpec(in *extensions.DeploymentSpec, out *DeploymentSpec, s conversion.Scope) error {
	...
	out.RevisionHistoryLimit = (*int32)(unsafe.Pointer(in.RevisionHistoryLimit))
	out.Paused = in.Paused
	out.RollbackTo = (*RollbackCon***REMOVED***g)(unsafe.Pointer(in.RollbackTo))
	out.ProgressDeadlineSeconds = (*int32)(unsafe.Pointer(in.ProgressDeadlineSeconds))
	return nil
}
...
func autoConvert_v1beta1_IngressStatus_To_extensions_IngressStatus(in *IngressStatus, out *extensions.IngressStatus, s conversion.Scope) error {
	// TODO: Inef***REMOVED***cient conversion - can we improve it?
...
func autoConvert_v1beta1_RollbackCon***REMOVED***g_To_extensions_RollbackCon***REMOVED***g(in *RollbackCon***REMOVED***g, out *extensions.RollbackCon***REMOVED***g, s conversion.Scope) error {
	out.Revision = in.Revision
	return nil
}

// Convert_v1beta1_RollbackCon***REMOVED***g_To_extensions_RollbackCon***REMOVED***g is an autogenerated conversion function.
func Convert_v1beta1_RollbackCon***REMOVED***g_To_extensions_RollbackCon***REMOVED***g(in *RollbackCon***REMOVED***g, out *extensions.RollbackCon***REMOVED***g, s conversion.Scope) error {
	return autoConvert_v1beta1_RollbackCon***REMOVED***g_To_extensions_RollbackCon***REMOVED***g(in, out, s)
}

func autoConvert_extensions_RollbackCon***REMOVED***g_To_v1beta1_RollbackCon***REMOVED***g(in *extensions.RollbackCon***REMOVED***g, out *RollbackCon***REMOVED***g, s conversion.Scope) error {
	out.Revision = in.Revision
	return nil
}

// Convert_extensions_RollbackCon***REMOVED***g_To_v1beta1_RollbackCon***REMOVED***g is an autogenerated conversion function.
func Convert_extensions_RollbackCon***REMOVED***g_To_v1beta1_RollbackCon***REMOVED***g(in *extensions.RollbackCon***REMOVED***g, out *RollbackCon***REMOVED***g, s conversion.Scope) error {
	return autoConvert_extensions_RollbackCon***REMOVED***g_To_v1beta1_RollbackCon***REMOVED***g(in, out, s)
}
