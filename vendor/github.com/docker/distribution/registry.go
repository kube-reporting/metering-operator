...
// Scope de***REMOVED***nes the set of items that match a namespace.
...
type Namespace interface {
	...
	// Repositories ***REMOVED***lls 'repos' with a lexigraphically sorted catalog of repositories
	// up to the size of 'repos' and returns the value 'n' for the number of entries
	// which were ***REMOVED***lled.  'last' contains an offset in the catalog, and 'err' will be
