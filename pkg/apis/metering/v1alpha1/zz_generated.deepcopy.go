...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenerationQueryViewDataSource) DeepCopyInto(out *GenerationQueryViewDataSource) {
	*out = *in
	if in.Inputs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenerationQueryViewDataSource.
func (in *GenerationQueryViewDataSource) DeepCopy() *GenerationQueryViewDataSource {
	if in == nil {
		return nil
	}
	out := new(GenerationQueryViewDataSource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReportDataSourceSpec) DeepCopyInto(out *ReportDataSourceSpec) {
	*out = *in
	...
	if in.GenerationQueryView != nil {
		in, out := &in.GenerationQueryView, &out.GenerationQueryView
		*out = new(GenerationQueryViewDataSource)
		(*in).DeepCopyInto(*out)
	}
	return
