...
// dispatchWithFilters call the function after passing through its own ***REMOVED***lters
...
// Return whether this Route can consume content with a type speci***REMOVED***ed by mimeTypes (can be empty).
...
func (r Route) extractParameters(urlPath string) map[string]string {
	...
	for i, key := range r.pathParts {
		...
		if strings.HasPre***REMOVED***x(key, "{") { // path-parameter
