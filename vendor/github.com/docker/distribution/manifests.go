...
// Instances can be obtained from a version-speci***REMOVED***c manifest package.  Manifest
// speci***REMOVED***c data is passed into the function which creates the builder.
...
type ManifestService interface {
	...
	// Get retrieves the manifest speci***REMOVED***ed by the given digest
	Get(ctx context.Context, dgst digest.Digest, options ...ManifestServiceOption) (Manifest, error)

	// Put creates or updates the given manifest returning the manifest digest
	Put(ctx context.Context, manifest Manifest, options ...ManifestServiceOption) (digest.Digest, error)

	// Delete removes the manifest speci***REMOVED***ed by the given digest. Deleting
...
// should be called from speci***REMOVED***c
