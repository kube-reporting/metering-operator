...
// NewRemote connects to the Prometheus using the given con***REMOVED***guration.
func NewRemote(promCon***REMOVED***g api.Con***REMOVED***g) (remote Remote, err error) {
	if remote.client, err = api.NewClient(promCon***REMOVED***g); err != nil {
