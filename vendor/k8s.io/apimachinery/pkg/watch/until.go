...
// or an error if the condition cannot be checked and should terminate. In general, it is better to de***REMOVED***ne
// level driven conditions over edge driven conditions (pod has ready=true, vs pod modi***REMOVED***ed and ready changed
// from false to true).
...
// encountered. The ***REMOVED***rst condition that returns an error terminates the watch (and the event is also returned).
// If no event has been received, the returned event will be nil.
// Conditions are satis***REMOVED***ed sequentially so as to provide a useful primitive for higher level composition.
