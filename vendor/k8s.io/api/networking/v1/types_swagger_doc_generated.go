...
var map_NetworkPolicyPeer = map[string]string{
	"":                  "NetworkPolicyPeer describes a peer to allow traf***REMOVED***c from. Exactly one of its ***REMOVED***elds must be speci***REMOVED***ed.",
...
var map_NetworkPolicyPort = map[string]string{
	...
	"protocol": "The protocol (TCP or UDP) which traf***REMOVED***c must match. If not speci***REMOVED***ed, this ***REMOVED***eld defaults to TCP.",
