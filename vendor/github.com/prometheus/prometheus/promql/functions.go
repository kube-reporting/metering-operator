...
// extrapolates if the ***REMOVED***rst/last sample is close to the boundary, and returns
...
func extrapolatedRate(ev *evaluator, arg Expr, isCounter bool, isRate bool) model.Value {
	...
	for _, samples := range matrixValue {
		...
		// Duration between ***REMOVED***rst/last samples and boundary of range.
		...
		// If the ***REMOVED***rst/last samples are close to the boundaries of the range,
...
func funcSort(ev *evaluator, args Expressions) model.Value {
	// NaN should sort to the bottom, so take descending sort with NaN ***REMOVED***rst and
	// reverse it.
...
func funcSortDesc(ev *evaluator, args Expressions) model.Value {
	// NaN should sort to the bottom, so take ascending sort with NaN ***REMOVED***rst and
	// reverse it.
...
// getFunction returns a prede***REMOVED***ned Function object for the given name.
