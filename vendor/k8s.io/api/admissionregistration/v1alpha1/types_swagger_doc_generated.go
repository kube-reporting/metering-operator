...
var map_AdmissionHookClientCon***REMOVED***g = map[string]string{
	"":         "AdmissionHookClientCon***REMOVED***g contains the information to make a TLS connection with the webhook",
	...
	"caBundle": "CABundle is a PEM encoded CA bundle which will be used to validate webhook's server certi***REMOVED***cate. Required",
}

func (AdmissionHookClientCon***REMOVED***g) SwaggerDoc() map[string]string {
	return map_AdmissionHookClientCon***REMOVED***g
}
...
var map_ExternalAdmissionHook = map[string]string{
	...
	"name":          "The name of the external admission webhook. Name should be fully quali***REMOVED***ed, e.g., imagepolicy.kubernetes.io, where \"imagepolicy\" is the name of the webhook, and kubernetes.io is the name of the organization. Required.",
...
var map_ExternalAdmissionHookCon***REMOVED***guration = map[string]string{
...
func (ExternalAdmissionHookCon***REMOVED***guration) SwaggerDoc() map[string]string {
	return map_ExternalAdmissionHookCon***REMOVED***guration
}

var map_ExternalAdmissionHookCon***REMOVED***gurationList = map[string]string{
	...
	"items":    "List of ExternalAdmissionHookCon***REMOVED***guration.",
}

func (ExternalAdmissionHookCon***REMOVED***gurationList) SwaggerDoc() map[string]string {
	return map_ExternalAdmissionHookCon***REMOVED***gurationList
}
