...
// Install modi***REMOVED***es PC registry to allow logging with an event source src.
// It adds all required keys and values to the event log registry key.
// Install uses msgFile as the event message ***REMOVED***le. If useExpandKey is true,
// the event message ***REMOVED***le is installed as REG_EXPAND_SZ value,
...
// %SystemRoot%\System32\EventCreate.exe as the event message ***REMOVED***le.
