...
// NewForCon***REMOVED***g creates a new $.GroupVersion$Client for the given con***REMOVED***g.
func NewForCon***REMOVED***g(c *$.restCon***REMOVED***g|raw$) (*$.GroupVersion$Client, error) {
	con***REMOVED***g := *c
...
// NewForCon***REMOVED***gOrDie creates a new $.GroupVersion$Client for the given con***REMOVED***g and
// panics if there is an error in the con***REMOVED***g.
func NewForCon***REMOVED***gOrDie(c *$.restCon***REMOVED***g|raw$) *$.GroupVersion$Client {
