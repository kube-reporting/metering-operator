...
// sourced adds a source ***REMOVED***eld to the logger that contains
// the ***REMOVED***le name and line where the logging happened.
func (l logger) sourced() *logrus.Entry {
	_, ***REMOVED***le, line, ok := runtime.Caller(2)
	if !ok {
		***REMOVED***le = "<???>"
		line = 1
	} ***REMOVED*** {
	...
	return l.entry.WithField("source", fmt.Sprintf("%s:%d", ***REMOVED***le, line))
}
...
// With adds a ***REMOVED***eld to the logger.
...
// in the ErrorLog ***REMOVED***eld of an http.Server to log HTTP server errors.
