...
// This class is also a serializer, but is generally used with a speci***REMOVED***c version.
func NewCodec(
	encoder runtime.Encoder,
	decoder runtime.Decoder,
...
type codec struct {
	...
	// originalSchemeName is optional, but when ***REMOVED***lled in it holds the name of the scheme from which this codec originates
	originalSchemeName string
}
