...
/*
This ***REMOVED***le (together with pkg/apis/extensions/v1beta1/types.go) contain the experimental
...
type DeploymentSpec struct {
	...
	// +optional
	RollbackTo *RollbackCon***REMOVED***g
...
// ReplicaSet represents the con***REMOVED***guration of a replica set.
type ReplicaSet struct {
	metav1.TypeMeta
	// +optional
	metav1.ObjectMeta

	// Spec de***REMOVED***nes the desired behavior of this ReplicaSet.
	// +optional
	Spec ReplicaSetSpec
