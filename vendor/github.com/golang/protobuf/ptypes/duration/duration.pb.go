...
func (*Duration) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptor0, []int{0} }
...
func init() {
	proto.RegisterFile("github.com/golang/protobuf/ptypes/duration/duration.proto", ***REMOVED***leDescriptor0)
}
