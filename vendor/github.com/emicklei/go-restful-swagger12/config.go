...
// MapSchemaFormatFunc can be used to modify typeName at de***REMOVED***nition time.
...
type Con***REMOVED***g struct {
	...
	Info Info
	// [optional] If set, model builder should call this handler to get addition typename-to-swagger-format-***REMOVED***eld conversion.
