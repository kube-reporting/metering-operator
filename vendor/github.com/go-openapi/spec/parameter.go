...
func FileParam(name string) *Parameter {
	return &Parameter{ParamProps: ParamProps{Name: name, In: "formData"}, SimpleSchema: SimpleSchema{Type: "***REMOVED***le"}}
}
...
// Parameter a unique parameter is de***REMOVED***ned by a combination of a [name](#parameterName) and [location](#parameterIn).
//
// There are ***REMOVED***ve possible parameter types.
...
func (p Parameter) JSONLookup(token string) (interface{}, error) {
	...
	if err != nil && !strings.HasPre***REMOVED***x(err.Error(), "object has no ***REMOVED***eld") {
		return nil, err
	}
	if r != nil {
		return r, nil
