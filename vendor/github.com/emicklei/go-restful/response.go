...
// the Response to ful***REMOVED***ll http.Hijacker if the underlying
// http.ResponseWriter supports it.
func (r *Response) Hijack() (net.Conn, *bu***REMOVED***o.ReadWriter, error) {
	if r.hijacker == nil {
...
// If no Accept header is speci***REMOVED***ed (or */*) then respond with the Content-Type as speci***REMOVED***ed by the ***REMOVED***rst in the Route.Produces.
// If an Accept header is speci***REMOVED***ed then respond with the Content-Type as speci***REMOVED***ed by the ***REMOVED***rst in the Route.Produces that is matched with the Accept header.
...
// CloseNotify is part of http.CloseNoti***REMOVED***er interface
func (r Response) CloseNotify() <-chan bool {
	return r.ResponseWriter.(http.CloseNoti***REMOVED***er).CloseNotify()
}
