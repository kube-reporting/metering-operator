...
type IteratorSeeker interface {
	// First moves the iterator to the ***REMOVED***rst key/value pair. If the iterator
	...
	// Seek moves the iterator to the ***REMOVED***rst key/value pair whose key is greater
