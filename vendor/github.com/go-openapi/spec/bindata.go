...
func (***REMOVED*** bindataFileInfo) Name() string {
	return ***REMOVED***.name
}
func (***REMOVED*** bindataFileInfo) Size() int64 {
	return ***REMOVED***.size
}
func (***REMOVED*** bindataFileInfo) Mode() os.FileMode {
	return ***REMOVED***.mode
}
func (***REMOVED*** bindataFileInfo) ModTime() time.Time {
	return ***REMOVED***.modTime
}
func (***REMOVED*** bindataFileInfo) IsDir() bool {
	return false
}
func (***REMOVED*** bindataFileInfo) Sys() interface{} {
	return nil
}
...
// It simpli***REMOVED***es safe initialization of global variables.
...
// AssetDir returns the ***REMOVED***le names below a certain
// directory embedded in the ***REMOVED***le by go-bindata.
...
func RestoreAsset(dir, name string) error {
	...
	err = os.MkdirAll(_***REMOVED***lePath(dir, ***REMOVED***lepath.Dir(name)), os.FileMode(0755))
	if err != nil {
		return err
	}
	err = ioutil.WriteFile(_***REMOVED***lePath(dir, name), data, info.Mode())
	if err != nil {
		return err
	}
	err = os.Chtimes(_***REMOVED***lePath(dir, name), info.ModTime(), info.ModTime())
	if err != nil {
		return err
	}
	return nil
...
func RestoreAssets(dir, name string) error {
	...
	for _, child := range children {
		err = RestoreAssets(dir, ***REMOVED***lepath.Join(name, child))
		if err != nil {
			return err
		}
	}
...
func _***REMOVED***lePath(dir, name string) string {
	cannonicalName := strings.Replace(name, "\\", "/", -1)
	return ***REMOVED***lepath.Join(append([]string{dir}, strings.Split(cannonicalName, "/")...)...)
}
