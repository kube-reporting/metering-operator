...
var map_PodAf***REMOVED***nity = map[string]string{
	...
	"requiredDuringSchedulingIgnoredDuringExecution":  "NOT YET IMPLEMENTED. TODO: Uncomment ***REMOVED***eld once it is implemented. If the af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld are not met at scheduling time, the pod will not be scheduled onto the node. If the af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld cease to be met at some point during pod execution (e.g. due to a pod label update), the system will try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAf***REMOVED***nityTerm are intersected, i.e. all terms must be satis***REMOVED***ed. RequiredDuringSchedulingRequiredDuringExecution []PodAf***REMOVED***nityTerm  `json:\"requiredDuringSchedulingRequiredDuringExecution,omitempty\"` If the af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld are not met at scheduling time, the pod will not be scheduled onto the node. If the af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAf***REMOVED***nityTerm are intersected, i.e. all terms must be satis***REMOVED***ed.",
...
var map_PodAntiAf***REMOVED***nity = map[string]string{
	...
	"requiredDuringSchedulingIgnoredDuringExecution":  "NOT YET IMPLEMENTED. TODO: Uncomment ***REMOVED***eld once it is implemented. If the anti-af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld cease to be met at some point during pod execution (e.g. due to a pod label update), the system will try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAf***REMOVED***nityTerm are intersected, i.e. all terms must be satis***REMOVED***ed. RequiredDuringSchedulingRequiredDuringExecution []PodAf***REMOVED***nityTerm  `json:\"requiredDuringSchedulingRequiredDuringExecution,omitempty\"` If the anti-af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-af***REMOVED***nity requirements speci***REMOVED***ed by this ***REMOVED***eld cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAf***REMOVED***nityTerm are intersected, i.e. all terms must be satis***REMOVED***ed.",
