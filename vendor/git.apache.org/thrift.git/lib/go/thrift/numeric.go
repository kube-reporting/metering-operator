...
func init() {
	INFINITY = &numeric{iValue: 0, dValue: math.Inf(1), sValue: "In***REMOVED***nity", isNil: false}
	NEGATIVE_INFINITY = &numeric{iValue: 0, dValue: math.Inf(-1), sValue: "-In***REMOVED***nity", isNil: false}
