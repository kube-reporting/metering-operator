...
// NewForCon***REMOVED***g creates a new RbacV1Client for the given con***REMOVED***g.
func NewForCon***REMOVED***g(c *rest.Con***REMOVED***g) (*RbacV1Client, error) {
	con***REMOVED***g := *c
...
// NewForCon***REMOVED***gOrDie creates a new RbacV1Client for the given con***REMOVED***g and
// panics if there is an error in the con***REMOVED***g.
func NewForCon***REMOVED***gOrDie(c *rest.Con***REMOVED***g) *RbacV1Client {
