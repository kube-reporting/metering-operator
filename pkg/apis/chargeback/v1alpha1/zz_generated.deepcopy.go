...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScheduledReportStorageLocation) DeepCopyInto(out *ScheduledReportStorageLocation) {
	*out = *in
	if in.StorageSpec != nil {
		in, out := &in.StorageSpec, &out.StorageSpec
		if *in == nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScheduledReportStorageLocation.
func (in *ScheduledReportStorageLocation) DeepCopy() *ScheduledReportStorageLocation {
	if in == nil {
		return nil
	}
	out := new(ScheduledReportStorageLocation)
	in.DeepCopyInto(out)
	return out
}
