...
type options struct {
	...
	mapping func(p *Pro***REMOVED***le, s string) (string, error)
...
// A Pro***REMOVED***le de***REMOVED***nes the con***REMOVED***guration of a IDNA mapper.
...
func normalize(p *Pro***REMOVED***le, s string) (string, error) {
	return norm.NFC.String(s), nil
}

func validateRegistration(p *Pro***REMOVED***le, s string) (string, error) {
...
func validateAndMap(p *Pro***REMOVED***le, s string) (string, error) {
	var (
		err error
		b   []byte
		k   int
...
func (p *Pro***REMOVED***le) validateLabel(s string) error {
	if s == "" {
		if p.verifyDNSLength {
