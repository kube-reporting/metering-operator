...
// ExecuteCreateS3Table creates a new table backed by the given S3 bucket/prefix with
// the specified columns
func ExecuteCreateS3Table(queryer db.Queryer, tableName, bucket, prefix string, columns []Column, dropTable bool) (TableParameters, TableProperties, error) {
