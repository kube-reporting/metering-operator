...
// XMLObject a metadata object that allows for more ***REMOVED***ne-tuned XML model de***REMOVED***nitions.
//
...
// WithPre***REMOVED***x sets the xml pre***REMOVED***x for the object
func (x *XMLObject) WithPre***REMOVED***x(pre***REMOVED***x string) *XMLObject {
	x.Pre***REMOVED***x = pre***REMOVED***x
	return x
}
