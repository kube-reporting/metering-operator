...
# used by e2e/integration tests for defaults
: "${METERING_OPERATOR_DEPLOY_REPO:=$METERING_OPERATOR_IMAGE_REPO}"
: "${REPORTING_OPERATOR_DEPLOY_REPO:=$REPORTING_OPERATOR_IMAGE_REPO}"
: "${METERING_OPERATOR_DEPLOY_TAG:=$METERING_OPERATOR_IMAGE_TAG}"
: "${REPORTING_OPERATOR_DEPLOY_TAG:=$REPORTING_OPERATOR_IMAGE_TAG}"
