...
func (adapter *Decoder) UseNumber() {
	origCfg := adapter.iter.cfg.con***REMOVED***gBeforeFrozen
	origCfg.UseNumber = true
	adapter.iter.cfg = origCfg.Froze().(*frozenCon***REMOVED***g)
}
...
func (adapter *Encoder) SetEscapeHTML(escapeHTML bool) {
	...
	adapter.stream.cfg = con***REMOVED***g.Froze().(*frozenCon***REMOVED***g)
}
