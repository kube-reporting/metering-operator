...
// called "pro***REMOVED***les" in other storage systems.
// The name of a StorageClass object is signi***REMOVED***cant, and is how users can request a particular class.
type StorageClass struct {
	...
	// This is an optionally-pre***REMOVED***xed name, like a label key.
