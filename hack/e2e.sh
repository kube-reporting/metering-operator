...
IMAGE_METERING_ANSIBLE_OPERATOR_REGISTRY="${IMAGE_METERING_ANSIBLE_OPERATOR_REGISTRY:=""}"
...
echo "\$IMAGE_METERING_ANSIBLE_OPERATOR_REGISTRY=$IMAGE_METERING_ANSIBLE_OPERATOR_REGISTRY"
...
go test \
    ...
    -registry-image="${IMAGE_METERING_ANSIBLE_OPERATOR_REGISTRY}" \
