...
const (
	...
	// If present then journal chunk checksum will be veri***REMOVED***ed.
	...
	// If present then 'sorted table' block checksum will be veri***REMOVED***ed.
...
type Options struct {
	// AltFilters de***REMOVED***nes one or more 'alternative ***REMOVED***lters'.
	// 'alternative ***REMOVED***lters' will be used during reads if a ***REMOVED***lter block
	// does not match with the 'effective ***REMOVED***lter'.
	//
	// The default value is nil
	AltFilters []***REMOVED***lter.Filter
	...
	// BlockCacheCapacity de***REMOVED***nes the capacity of the 'sorted table' block caching.
	...
	// CompactionL0Trigger de***REMOVED***nes number of 'sorted table' at level-0 that will
	// trigger compaction.
	//
	...
	// The multiplier for each level can also ***REMOVED***ne-tuned using CompactionTableSizeMultiplierPerLevel.
	//
	// The default value is 2MiB.
	CompactionTableSize int

	// CompactionTableSizeMultiplier de***REMOVED***nes multiplier for CompactionTableSize.
	//
	// The default value is 1.
	CompactionTableSizeMultiplier float64

	// CompactionTableSizeMultiplierPerLevel de***REMOVED***nes per-level multiplier for
	// CompactionTableSize.
	...
	// The multiplier for each level can also ***REMOVED***ne-tuned using
	// CompactionTotalSizeMultiplierPerLevel.
	//
	// The default value is 10MiB.
	CompactionTotalSize int

	// CompactionTotalSizeMultiplier de***REMOVED***nes multiplier for CompactionTotalSize.
	//
	// The default value is 10.
	CompactionTotalSizeMultiplier float64

	// CompactionTotalSizeMultiplierPerLevel de***REMOVED***nes per-level multiplier for
	// CompactionTotalSize.
	// Use zero to skip a level.
	//
	// The default value is nil.
	...
	// Comparer de***REMOVED***nes a total ordering over the space of []byte keys: a 'less
	...
	// Compression de***REMOVED***nes the 'sorted table' block compression to use.
	//
	...
	// ErrorIfExist de***REMOVED***nes whether an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing de***REMOVED***nes whether an error should returned if the DB is
	...
	// Filter de***REMOVED***nes an 'effective ***REMOVED***lter' to use. An 'effective ***REMOVED***lter'
	// if de***REMOVED***ned will be used to generate per-table ***REMOVED***lter block.
	// The ***REMOVED***lter name will be stored on disk.
	// During reads LevelDB will try to ***REMOVED***nd matching ***REMOVED***lter from
	// 'effective ***REMOVED***lter' and 'alternative ***REMOVED***lters'.
	//
	// Filter can be changed after a DB has been created. It is recommended
	// to put old ***REMOVED***lter to the 'alternative ***REMOVED***lters' to mitigate lack of
	// ***REMOVED***lter during transition period.
	//
	// A ***REMOVED***lter is used to reduce disk reads when looking for a speci***REMOVED***c key.
	//
	// The default value is nil.
	Filter ***REMOVED***lter.Filter

	// IteratorSamplingRate de***REMOVED***nes approximate gap (in bytes) between read
	...
	// OpenFilesCacher provides cache algorithm for open ***REMOVED***les caching.
	// Specify NoCacher to disable caching algorithm.
	//
	// The default value is LRUCacher.
	OpenFilesCacher Cacher

	// OpenFilesCacheCapacity de***REMOVED***nes the capacity of the open ***REMOVED***les caching.
	...
	// Strict de***REMOVED***nes the DB strict level.
	Strict Strict

	// WriteBuffer de***REMOVED***nes maximum size of a 'memdb' before flushed to
	...
	// WriteL0StopTrigger de***REMOVED***nes number of 'sorted table' at level-0 that will
	// pause write.
	//
	// The default value is 12.
	WriteL0PauseTrigger int

	// WriteL0SlowdownTrigger de***REMOVED***nes number of 'sorted table' at level-0 that
...
func (o *Options) GetAltFilters() []***REMOVED***lter.Filter {
	if o == nil {
		return nil
	}
	return o.AltFilters
...
func (o *Options) GetBlockCacher() Cacher {
	...
	} ***REMOVED*** if o.BlockCacher == NoCacher {
		return nil
	}
...
func (o *Options) GetBlockCacheCapacity() int {
	...
	} ***REMOVED*** if o.BlockCacheCapacity < 0 {
		return 0
	}
...
func (o *Options) GetCompactionTableSize(level int) int {
	...
	if o != nil {
		...
		} ***REMOVED*** if o.CompactionTableSizeMultiplier > 0 {
...
func (o *Options) GetCompactionTotalSize(level int) int64 {
	...
	if o != nil {
		...
		} ***REMOVED*** if o.CompactionTotalSizeMultiplier > 0 {
...
func (o *Options) GetFilter() ***REMOVED***lter.Filter {
	if o == nil {
		return nil
	}
	return o.Filter
...
func (o *Options) GetOpenFilesCacheCapacity() int {
	...
	} ***REMOVED*** if o.OpenFilesCacheCapacity < 0 {
		return 0
	}
...
type ReadOptions struct {
	// DontFillCache de***REMOVED***nes whether block reads for this 'read operation'
