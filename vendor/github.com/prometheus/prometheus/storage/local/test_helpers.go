...
// NOTE ON FILENAME: Do not rename this ***REMOVED***le helpers_test.go (which might appear
...
// NewTestStorage creates a storage instance backed by ***REMOVED***les in a temporary
...
func makeFingerprintSeriesPair(s *MemorySeriesStorage, fp model.Fingerprint) ***REMOVED***ngerprintSeriesPair {
	return ***REMOVED***ngerprintSeriesPair{fp, s.seriesForRange(fp, model.Earliest, model.Latest)}
}
