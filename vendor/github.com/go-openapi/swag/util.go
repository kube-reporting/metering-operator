...
func split(str string) (words []string) {
	...
	// Get the ***REMOVED***nal list of words
...
// ToHumanNameTitle represents a code name as a human series of words with the ***REMOVED***rst letters titleized
...
// CommandLineOptionsGroup represents a group of user-de***REMOVED***ned command line options
