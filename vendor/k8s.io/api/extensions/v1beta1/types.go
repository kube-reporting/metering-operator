...
// more information.
// ReplicaSet represents the con***REMOVED***guration of a ReplicaSet.
...
// Pod Security Policy Spec de***REMOVED***nes the policy enforced.
type PodSecurityPolicySpec struct {
	// privileged determines if a pod can request to be run as privileged.
	// +optional
	Privileged bool `json:"privileged,omitempty" protobuf:"varint,1,opt,name=privileged"`
	// DefaultAddCapabilities is the default set of capabilities that will be added to the container
	// unless the pod spec speci***REMOVED***cally drops the capability.  You may not list a capabiility in both
...
// de***REMOVED***nes the host volume conditions that will be enabled by a policy
// for pods to use. It requires the path pre***REMOVED***x to be de***REMOVED***ned.
type AllowedHostPath struct {
	// is the path pre***REMOVED***x that the host volume must match.
	// It does not support `*`.
...
// FS Type gives strong typing to different ***REMOVED***le systems that are used by volumes.
type FSType string
...
// Host Port Range de***REMOVED***nes a range of host ports that will be enabled by a policy
...
// SELinux  Strategy Options de***REMOVED***nes the strategy type and any options used to create the strategy.
...
// Run A sUser Strategy Options de***REMOVED***nes the strategy type and any options used to create the strategy.
...
type NetworkPolicyPort struct {
	// Optional.  The protocol (TCP or UDP) which traf***REMOVED***c must match.
...
type NetworkPolicyPeer struct {
	// Exactly one of the following must be speci***REMOVED***ed.

	// This is a label selector which selects Pods in this namespace.
	// This ***REMOVED***eld follows standard label selector semantics.
