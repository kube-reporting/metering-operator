...
You may also schedule a job to execute at ***REMOVED***xed intervals.  This is supported by
...
The time zone may be overridden by providing an additional space-separated ***REMOVED***eld
