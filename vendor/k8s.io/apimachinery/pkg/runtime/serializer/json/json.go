...
// normal JSON/YAML unmarshalling. If into is provided and the original data is not fully quali***REMOVED***ed with kind/version/group, the type of
...
func (s *Serializer) Decode(originalData []byte, gvk *schema.GroupVersionKind, into runtime.Object) (runtime.Object, *schema.GroupVersionKind, error) {
	...
	if into != nil {
		...
		case runtime.IsNotRegisteredError(err), isUnstructured:
			if err := jsoniter.Con***REMOVED***gFastest.Unmarshal(data, into); err != nil {
				return nil, actual, err
			}
	...
	if err := jsoniter.Con***REMOVED***gFastest.Unmarshal(data, obj); err != nil {
		return nil, actual, err
	}
...
func (s *Serializer) Encode(obj runtime.Object, w io.Writer) error {
	if s.yaml {
		json, err := jsoniter.Con***REMOVED***gFastest.Marshal(obj)
		if err != nil {
			return err
		}
	...
	if s.pretty {
		data, err := jsoniter.Con***REMOVED***gFastest.MarshalIndent(obj, "", "  ")
		if err != nil {
			return err
		}
		_, err = w.Write(data)
