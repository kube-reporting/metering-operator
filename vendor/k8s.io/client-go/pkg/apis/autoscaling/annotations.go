...
// specs when converting the `Metrics` ***REMOVED***eld from autoscaling/v2alpha1
...
// statuses when converting the `CurrentMetrics` ***REMOVED***eld from autoscaling/v2alpha1
...
// of an HPA when converting the `Conditions` ***REMOVED***eld from autoscaling/v2alpha1
