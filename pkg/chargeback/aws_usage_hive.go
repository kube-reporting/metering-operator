...
func CreateAWSUsageTable(queryer db.Queryer, tableName, bucket, pre***REMOVED***x string, manifests []*aws.Manifest) (hive.TableParameters, hive.TableProperties, error) {
