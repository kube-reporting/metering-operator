...
// in the IAM User Guide.
//
// The temporary security credentials are valid for the duration that you speci***REMOVED***ed
...
// by the operation have the permissions that are de***REMOVED***ned in the access policy
...
// relationship is de***REMOVED***ned in the role's trust policy when the role is created.
...
//
// For more information, see Con***REMOVED***guring MFA-Protected API Access (http://docs.aws.amazon.com/IAM/latest/UserGuide/MFAProtectedAPI.html)
...
//
// The temporary security credentials are valid for the duration that you speci***REMOVED***ed
// when calling AssumeRole, or until the time speci***REMOVED***ed in the SAML authentication
...
// an IAM role that speci***REMOVED***es this SAML provider in its trust policy.
//
...
//    in the IAM User Guide.
//
//    * Con***REMOVED***guring a Relying Party and Claims (http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_create_saml_relying-party.html)
//    in the IAM User Guide.
//
...
//
// The credentials are valid for the duration that you speci***REMOVED***ed when calling
...
// credentials of an IAM user are valid for the speci***REMOVED***ed duration, from 900
...
// passed policy cannot grant more permissions than those that are de***REMOVED***ned in
// the IAM user policy.
//
...
// that speci***REMOVED***cally allows the federated user to access the resource.
//
...
// programmatic calls to speci***REMOVED***c AWS APIs like Amazon EC2 StopInstances. MFA-enabled
...
type AssumeRoleInput struct {
	...
	// a console sign-in token takes a SessionDuration parameter that speci***REMOVED***es
	...
	// A unique identi***REMOVED***er that is used by third parties when assuming roles in
...
type AssumeRoleOutput struct {
	...
	//
	// Note: The size of the security token that STS APIs return is not ***REMOVED***xed. We
...
type AssumeRoleWithSAMLInput struct {
	...
	// The duration, in seconds, of the role session. The value can range from 900
	// seconds (15 minutes) to 3600 seconds (1 hour). By default, the value is set
	// to 3600 seconds. An expiration can also be speci***REMOVED***ed in the SAML authentication
	...
	//
	// For more information, see Con***REMOVED***guring a Relying Party and Adding Claims (http://docs.aws.amazon.com/IAM/latest/UserGuide/create-role-saml-IdP-tasks.html)
...
type AssumedRoleUser struct {
	...
	// policies, see IAM Identi***REMOVED***ers (http://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identi***REMOVED***ers.html)
	// in Using IAM.
	//
...
type FederatedUser struct {
	...
	// Identi***REMOVED***ers (http://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identi***REMOVED***ers.html)
	// in Using IAM.
	//
	// Arn is a required ***REMOVED***eld
	Arn *string `min:"20" type:"string" required:"true"`
...
type GetFederationTokenInput struct {
	...
	// to the IAM user. The ***REMOVED***nal permissions for the federated user are the most
