...
var prestotablesResource = schema.GroupVersionResource{Group: "metering.openshift.io", Version: "v1alpha1", Resource: "prestotables"}

var prestotablesKind = schema.GroupVersionKind{Group: "metering.openshift.io", Version: "v1alpha1", Kind: "PrestoTable"}
...
func (c *FakePrestoTables) List(opts v1.ListOptions) (result *v1alpha1.PrestoTableList, err error) {
	...
	list := &v1alpha1.PrestoTableList{ListMeta: obj.(*v1alpha1.PrestoTableList).ListMeta}
...
func (c *FakePrestoTables) UpdateStatus(prestoTable *v1alpha1.PrestoTable) (*v1alpha1.PrestoTable, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(prestotablesResource, "status", c.ns, prestoTable), &v1alpha1.PrestoTable{})
...
func (c *FakePrestoTables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.PrestoTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(prestotablesResource, c.ns, name, pt, data, subresources...), &v1alpha1.PrestoTable{})
