...
type Storage interface {
	...
	// This SampleAppender needs multiple samples for the same ***REMOVED***ngerprint to be
...
type Querier interface {
	...
	// of matching series is computed. The ***REMOVED***nal return value will be the union
	...
	// have no samples in the speci***REMOVED***ed interval from the returned map. In
	...
	// All returned samples are between the speci***REMOVED***ed cutoff time and now.
...
// SeriesIterator enables ef***REMOVED***cient access of sample values in a series. Its
...
// of the series prior to the modi***REMOVED***cation.
