...
// IsConversionIgnored returns true if the speci***REMOVED***ed objects should be dropped during
// conversion.
...
// SetStructFieldCopy registers a correspondence. Whenever a struct ***REMOVED***eld is encountered
// which has a type and name matching srcFieldType and srcFieldName, it wil be copied
// into the ***REMOVED***eld in the destination struct matching destFieldType & Name, if such a
// ***REMOVED***eld exists.
// May be called multiple times, even for the same source ***REMOVED***eld & type--all applicable
