		...
		if unicode.Is(unicode.Greek, r) {
			if b := norm.NFD.PropertiesString(string(r)).Decomposition(); b != nil {
				...
				if f := runes[0]; unicode.IsMark(f) || f > 0xFF && !unicode.Is(unicode.Greek, f) {
					log.Fatalf("%U: expeced ***REMOVED***rst rune of Greek decomposition to be letter, found %U", r, f)
				}
				...
				for _, m := range runes[1:] {
					...
					default:
						log.Fatalf("%U: modi***REMOVED***er %U is outside of expeced Greek modi***REMOVED***er set", r, m)
					}
				}
			}
		}
