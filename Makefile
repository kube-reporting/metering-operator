...
chargeback-helm-operator-docker-build: images/chargeback-helm-operator/Dockerfile images/chargeback-helm-operator/tectonic-chargeback-0.1.0.tgz images/chargeback-helm-operator/chargeback-override-values.yaml images/chargeback-helm-operator/openshift-chargeback-0.1.0.tgz helm-operator-docker-build
...
images/chargeback-helm-operator/tectonic-chargeback-0.1.0.tgz: images/chargeback-helm-operator/chargeback-override-values.yaml $(shell find charts -type f)
...
images/chargeback-helm-operator/openshift-chargeback-0.1.0.tgz: images/chargeback-helm-operator/chargeback-override-values.yaml $(shell find charts -type f)
