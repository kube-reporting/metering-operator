...
```
http://127.0.0.1:8001/api/v1/namespaces/metering/services/metering/proxy/api/v1/reports/get?name=[Report Name]&format=[Format]
```
...
```
$ curl "http://127.0.0.1:8001/api/v1/namespaces/metering/services/metering/proxy/api/v1/reports/get?name=namespace-cpu-request&format=csv"
```
