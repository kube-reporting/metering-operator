			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					if x.LastScaleTime == nil {
						...
						_ = yym9
						if false {
						} ***REMOVED*** if z.HasExtensions() && z.EncExt(x.LastScaleTime) {
						} ***REMOVED*** if yym9 {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "lastScaleTime":
			if r.TryDecodeAsNil() {
				...
				_ = yym7
				if false {
				} ***REMOVED*** if z.HasExtensions() && z.DecExt(x.LastScaleTime) {
				} ***REMOVED*** if yym7 {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				_ = yym15
				if false {
				} ***REMOVED*** if z.HasExtensions() && z.EncExt(yy14) {
				} ***REMOVED*** if !yym15 && z.IsJSONHandle() {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "targetValue":
			if r.TryDecodeAsNil() {
				...
				_ = yym8
				if false {
				} ***REMOVED*** if z.HasExtensions() && z.DecExt(yyv7) {
...
func (x *ObjectMetricSource) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		_ = yym14
		if false {
		} ***REMOVED*** if z.HasExtensions() && z.DecExt(yyv13) {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					if x.TargetAverageValue == nil {
						...
						_ = yym12
						if false {
						} ***REMOVED*** if z.HasExtensions() && z.EncExt(x.TargetAverageValue) {
						} ***REMOVED*** if !yym12 && z.IsJSONHandle() {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "targetAverageValue":
			if r.TryDecodeAsNil() {
				...
				_ = yym8
				if false {
				} ***REMOVED*** if z.HasExtensions() && z.DecExt(x.TargetAverageValue) {
				} ***REMOVED*** if !yym8 && z.IsJSONHandle() {
