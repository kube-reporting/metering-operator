...
type delayingType struct {
	...
	// clock tracks time for delayed ***REMOVED***ring
	clock clock.Clock

	// stopCh lets us signal a shutdown to the waiting loop
	stopCh chan struct{}

	// heartbeat ensures we wait no more than maxWait before ***REMOVED***ring
	//
...
func (q *delayingType) waitingLoop() {
	...
	for {
		...
		// Set up a wait for the ***REMOVED***rst item's readyAt (if one exists)
		nextReadyAt := never
