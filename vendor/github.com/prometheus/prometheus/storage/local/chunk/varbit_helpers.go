...
// signi***REMOVED***cant bits after that in the given bit pattern. The maximum number of
// leading zeros is 31 (so that it can be represented by a 5bit number). Leading
// zeros beyond that are considered part of the signi***REMOVED***cant bits.
func countBits(pattern uint64) (leading, signi***REMOVED***cant byte) {
