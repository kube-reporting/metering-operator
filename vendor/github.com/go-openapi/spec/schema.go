...
// Schema the schema object allows the de***REMOVED***nition of input and output data types.
// These types can be objects, but also primitives and arrays.
// This object is based on the [JSON Schema Speci***REMOVED***cation Draft 4](http://json-schema.org/)
// and uses a prede***REMOVED***ned subset of it.
// On top of this subset, there are extensions provided by this speci***REMOVED***cation to allow for more complete documentation.
//
...
func (s Schema) JSONLookup(token string) (interface{}, error) {
	...
	if r != nil || (err != nil && !strings.HasPre***REMOVED***x(err.Error(), "object has no ***REMOVED***eld")) {
		return r, err
	}
...
// AddRequired  adds ***REMOVED***eld names to the required properties array
...
// WithDiscriminator sets the name of the discriminator ***REMOVED***eld
...
// WithXMLPre***REMOVED***x sets the xml pre***REMOVED***x for the object
func (s *Schema) WithXMLPre***REMOVED***x(pre***REMOVED***x string) *Schema {
	if s.XML == nil {
		s.XML = new(XMLObject)
	}
	s.XML.Pre***REMOVED***x = pre***REMOVED***x
	return s
}
...
func (s *Schema) UnmarshalJSON(data []byte) error {
	...
	for k, vv := range d {
		...
		if strings.HasPre***REMOVED***x(lk, "x-") {
