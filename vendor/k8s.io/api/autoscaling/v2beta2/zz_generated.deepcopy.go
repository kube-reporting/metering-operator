...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricIdenti***REMOVED***er) DeepCopyInto(out *MetricIdenti***REMOVED***er) {
	*out = *in
	if in.Selector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricIdenti***REMOVED***er.
func (in *MetricIdenti***REMOVED***er) DeepCopy() *MetricIdenti***REMOVED***er {
	if in == nil {
		return nil
	}
	out := new(MetricIdenti***REMOVED***er)
	in.DeepCopyInto(out)
	return out
}
