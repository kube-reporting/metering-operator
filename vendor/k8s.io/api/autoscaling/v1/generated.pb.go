...
func (*HorizontalPodAutoscaler) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{1} }
...
func (*MetricSpec) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{6} }

func (m *MetricStatus) Reset()                    { *m = MetricStatus{} }
func (*MetricStatus) ProtoMessage()               {}
func (*MetricStatus) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{7} }

func (m *ObjectMetricSource) Reset()                    { *m = ObjectMetricSource{} }
func (*ObjectMetricSource) ProtoMessage()               {}
func (*ObjectMetricSource) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{8} }

func (m *ObjectMetricStatus) Reset()                    { *m = ObjectMetricStatus{} }
func (*ObjectMetricStatus) ProtoMessage()               {}
func (*ObjectMetricStatus) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{9} }

func (m *PodsMetricSource) Reset()                    { *m = PodsMetricSource{} }
func (*PodsMetricSource) ProtoMessage()               {}
func (*PodsMetricSource) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{10} }

func (m *PodsMetricStatus) Reset()                    { *m = PodsMetricStatus{} }
func (*PodsMetricStatus) ProtoMessage()               {}
func (*PodsMetricStatus) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{11} }

func (m *ResourceMetricSource) Reset()                    { *m = ResourceMetricSource{} }
func (*ResourceMetricSource) ProtoMessage()               {}
func (*ResourceMetricSource) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{12} }

func (m *ResourceMetricStatus) Reset()                    { *m = ResourceMetricStatus{} }
func (*ResourceMetricStatus) ProtoMessage()               {}
func (*ResourceMetricStatus) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{13} }

func (m *Scale) Reset()                    { *m = Scale{} }
func (*Scale) ProtoMessage()               {}
func (*Scale) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{14} }

func (m *ScaleSpec) Reset()                    { *m = ScaleSpec{} }
func (*ScaleSpec) ProtoMessage()               {}
func (*ScaleSpec) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{15} }

func (m *ScaleStatus) Reset()                    { *m = ScaleStatus{} }
func (*ScaleStatus) ProtoMessage()               {}
func (*ScaleStatus) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{16} }
...
func (m *HorizontalPodAutoscalerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld TargetCPUUtilizationPercentage", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *HorizontalPodAutoscalerStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld CurrentCPUUtilizationPercentage", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ObjectMetricSource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld MetricName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *PodsMetricSource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld TargetAverageValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *PodsMetricStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld CurrentAverageValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ResourceMetricSource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld TargetAverageUtilization", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ResourceMetricStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		***REMOVED***eldNum := int32(wire >> 3)
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for ***REMOVED***eld CurrentAverageUtilization", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() {
	proto.RegisterFile("k8s.io/kubernetes/vendor/k8s.io/api/autoscaling/v1/generated.proto", ***REMOVED***leDescriptorGenerated)
}
