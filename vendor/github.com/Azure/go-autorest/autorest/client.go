...
var (
	// StatusCodesForRetry are a de***REMOVED***ned group of status code for which the client will retry
...
// ClientOptions contains various Client con***REMOVED***guration options.
...
// NewClientWithOptions returns an instance of a Client with the speci***REMOVED***ed values.
