...
//  1. if KUBE_API_VERSIONS is speci***REMOVED***ed, then KUBE_API_VERSIONS in order, OR
...
// prioritiesForGroups returns the resource and kind priorities for a PriorityRESTMapper, preferring the preferred version of each group ***REMOVED***rst,
