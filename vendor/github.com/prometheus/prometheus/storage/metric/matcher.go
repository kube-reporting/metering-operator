...
// LabelMatcher that is expected to yield the fewest matches is ***REMOVED***rst in the
...
//   the blunt expectation that a long label name and/or value is more speci***REMOVED***c
