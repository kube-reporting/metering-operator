...
var map_PriorityClass = map[string]string{
	...
	"globalDefault": "globalDefault speci***REMOVED***es whether this PriorityClass should be considered as the default priority for pods that do not have any priority class.",
