...
type CustomArgs struct {
	...
	// Custom peer dirs which are application speci***REMOVED***c. Peer dirs are declared to make the
...
func Validate(genericArgs *args.GeneratorArgs) error {
	...
	if len(genericArgs.OutputFileBaseName) == 0 {
		return fmt.Errorf("output ***REMOVED***le base name cannot be empty")
	}
