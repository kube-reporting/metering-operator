...
func decoderOfSlice(cfg *frozenCon***REMOVED***g, typ reflect.Type) (ValDecoder, error) {
...
func encoderOfSlice(cfg *frozenCon***REMOVED***g, typ reflect.Type) (ValEncoder, error) {
