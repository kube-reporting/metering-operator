...
//
// It can be used to implement static content ***REMOVED***les.
type DefaultGen struct {
	// OptionalName, if present, will be used for the generator's name, and
	// the ***REMOVED***lename (with ".go" appended).
	OptionalName string

	// OptionalBody, if present, will be used as the return from the "Init"
	// method. This causes it to be static content for the entire ***REMOVED***le if
	// no other generator touches the ***REMOVED***le.
	OptionalBody []byte
}
