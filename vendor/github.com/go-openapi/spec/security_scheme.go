...
func APIKeyAuth(***REMOVED***eldName, valueSource string) *SecurityScheme {
	return &SecurityScheme{SecuritySchemeProps: SecuritySchemeProps{Type: apiKey, Name: ***REMOVED***eldName, In: valueSource}}
}
...
// SecurityScheme allows the de***REMOVED***nition of a security scheme that can be used by the operations.
