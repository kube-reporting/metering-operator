...
// unquoteChar decodes the ***REMOVED***rst character or byte in the escaped string
...
//
// The second argument, quote, speci***REMOVED***es the type of literal being parsed
