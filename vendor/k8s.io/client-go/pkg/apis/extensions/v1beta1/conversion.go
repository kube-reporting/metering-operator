...
func Convert_v1beta1_ScaleStatus_To_extensions_ScaleStatus(in *ScaleStatus, out *extensions.ScaleStatus, s conversion.Scope) error {
	...
	// Normally when 2 ***REMOVED***elds map to the same internal value we favor the old ***REMOVED***eld, since
	// old clients can't be expected to know about new ***REMOVED***elds but clients that know about the
	// new ***REMOVED***eld can be expected to know about the old ***REMOVED***eld (though that's not quite true, due
	// to kubectl apply). However, these ***REMOVED***elds are readonly, so any non-nil value should work.
...
func Convert_extensions_DeploymentSpec_To_v1beta1_DeploymentSpec(in *extensions.DeploymentSpec, out *DeploymentSpec, s conversion.Scope) error {
	...
	if in.RollbackTo != nil {
		out.RollbackTo = new(RollbackCon***REMOVED***g)
...
func Convert_v1beta1_DeploymentSpec_To_extensions_DeploymentSpec(in *DeploymentSpec, out *extensions.DeploymentSpec, s conversion.Scope) error {
	...
	out.Paused = in.Paused
	if in.RollbackTo != nil {
		out.RollbackTo = new(extensions.RollbackCon***REMOVED***g)
