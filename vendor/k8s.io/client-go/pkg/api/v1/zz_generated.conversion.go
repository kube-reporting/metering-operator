...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_Af***REMOVED***nity_To_api_Af***REMOVED***nity,
		Convert_api_Af***REMOVED***nity_To_v1_Af***REMOVED***nity,
		...
		Convert_v1_Con***REMOVED***gMap_To_api_Con***REMOVED***gMap,
		Convert_api_Con***REMOVED***gMap_To_v1_Con***REMOVED***gMap,
		Convert_v1_Con***REMOVED***gMapEnvSource_To_api_Con***REMOVED***gMapEnvSource,
		Convert_api_Con***REMOVED***gMapEnvSource_To_v1_Con***REMOVED***gMapEnvSource,
		Convert_v1_Con***REMOVED***gMapKeySelector_To_api_Con***REMOVED***gMapKeySelector,
		Convert_api_Con***REMOVED***gMapKeySelector_To_v1_Con***REMOVED***gMapKeySelector,
		Convert_v1_Con***REMOVED***gMapList_To_api_Con***REMOVED***gMapList,
		Convert_api_Con***REMOVED***gMapList_To_v1_Con***REMOVED***gMapList,
		Convert_v1_Con***REMOVED***gMapProjection_To_api_Con***REMOVED***gMapProjection,
		Convert_api_Con***REMOVED***gMapProjection_To_v1_Con***REMOVED***gMapProjection,
		Convert_v1_Con***REMOVED***gMapVolumeSource_To_api_Con***REMOVED***gMapVolumeSource,
		Convert_api_Con***REMOVED***gMapVolumeSource_To_v1_Con***REMOVED***gMapVolumeSource,
		...
		Convert_v1_NodeAf***REMOVED***nity_To_api_NodeAf***REMOVED***nity,
		Convert_api_NodeAf***REMOVED***nity_To_v1_NodeAf***REMOVED***nity,
		...
		Convert_v1_PodAf***REMOVED***nity_To_api_PodAf***REMOVED***nity,
		Convert_api_PodAf***REMOVED***nity_To_v1_PodAf***REMOVED***nity,
		Convert_v1_PodAf***REMOVED***nityTerm_To_api_PodAf***REMOVED***nityTerm,
		Convert_api_PodAf***REMOVED***nityTerm_To_v1_PodAf***REMOVED***nityTerm,
		Convert_v1_PodAntiAf***REMOVED***nity_To_api_PodAntiAf***REMOVED***nity,
		Convert_api_PodAntiAf***REMOVED***nity_To_v1_PodAntiAf***REMOVED***nity,
		...
		Convert_v1_WeightedPodAf***REMOVED***nityTerm_To_api_WeightedPodAf***REMOVED***nityTerm,
		Convert_api_WeightedPodAf***REMOVED***nityTerm_To_v1_WeightedPodAf***REMOVED***nityTerm,
	)
}
...
func autoConvert_v1_Af***REMOVED***nity_To_api_Af***REMOVED***nity(in *Af***REMOVED***nity, out *api.Af***REMOVED***nity, s conversion.Scope) error {
	out.NodeAf***REMOVED***nity = (*api.NodeAf***REMOVED***nity)(unsafe.Pointer(in.NodeAf***REMOVED***nity))
	out.PodAf***REMOVED***nity = (*api.PodAf***REMOVED***nity)(unsafe.Pointer(in.PodAf***REMOVED***nity))
	out.PodAntiAf***REMOVED***nity = (*api.PodAntiAf***REMOVED***nity)(unsafe.Pointer(in.PodAntiAf***REMOVED***nity))
	return nil
}

// Convert_v1_Af***REMOVED***nity_To_api_Af***REMOVED***nity is an autogenerated conversion function.
func Convert_v1_Af***REMOVED***nity_To_api_Af***REMOVED***nity(in *Af***REMOVED***nity, out *api.Af***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_v1_Af***REMOVED***nity_To_api_Af***REMOVED***nity(in, out, s)
}

func autoConvert_api_Af***REMOVED***nity_To_v1_Af***REMOVED***nity(in *api.Af***REMOVED***nity, out *Af***REMOVED***nity, s conversion.Scope) error {
	out.NodeAf***REMOVED***nity = (*NodeAf***REMOVED***nity)(unsafe.Pointer(in.NodeAf***REMOVED***nity))
	out.PodAf***REMOVED***nity = (*PodAf***REMOVED***nity)(unsafe.Pointer(in.PodAf***REMOVED***nity))
	out.PodAntiAf***REMOVED***nity = (*PodAntiAf***REMOVED***nity)(unsafe.Pointer(in.PodAntiAf***REMOVED***nity))
	return nil
}

// Convert_api_Af***REMOVED***nity_To_v1_Af***REMOVED***nity is an autogenerated conversion function.
func Convert_api_Af***REMOVED***nity_To_v1_Af***REMOVED***nity(in *api.Af***REMOVED***nity, out *Af***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_api_Af***REMOVED***nity_To_v1_Af***REMOVED***nity(in, out, s)
}
...
func autoConvert_v1_Con***REMOVED***gMap_To_api_Con***REMOVED***gMap(in *Con***REMOVED***gMap, out *api.Con***REMOVED***gMap, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	return nil
}

// Convert_v1_Con***REMOVED***gMap_To_api_Con***REMOVED***gMap is an autogenerated conversion function.
func Convert_v1_Con***REMOVED***gMap_To_api_Con***REMOVED***gMap(in *Con***REMOVED***gMap, out *api.Con***REMOVED***gMap, s conversion.Scope) error {
	return autoConvert_v1_Con***REMOVED***gMap_To_api_Con***REMOVED***gMap(in, out, s)
}

func autoConvert_api_Con***REMOVED***gMap_To_v1_Con***REMOVED***gMap(in *api.Con***REMOVED***gMap, out *Con***REMOVED***gMap, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	return nil
}

// Convert_api_Con***REMOVED***gMap_To_v1_Con***REMOVED***gMap is an autogenerated conversion function.
func Convert_api_Con***REMOVED***gMap_To_v1_Con***REMOVED***gMap(in *api.Con***REMOVED***gMap, out *Con***REMOVED***gMap, s conversion.Scope) error {
	return autoConvert_api_Con***REMOVED***gMap_To_v1_Con***REMOVED***gMap(in, out, s)
}

func autoConvert_v1_Con***REMOVED***gMapEnvSource_To_api_Con***REMOVED***gMapEnvSource(in *Con***REMOVED***gMapEnvSource, out *api.Con***REMOVED***gMapEnvSource, s conversion.Scope) error {
...
// Convert_v1_Con***REMOVED***gMapEnvSource_To_api_Con***REMOVED***gMapEnvSource is an autogenerated conversion function.
func Convert_v1_Con***REMOVED***gMapEnvSource_To_api_Con***REMOVED***gMapEnvSource(in *Con***REMOVED***gMapEnvSource, out *api.Con***REMOVED***gMapEnvSource, s conversion.Scope) error {
	return autoConvert_v1_Con***REMOVED***gMapEnvSource_To_api_Con***REMOVED***gMapEnvSource(in, out, s)
}

func autoConvert_api_Con***REMOVED***gMapEnvSource_To_v1_Con***REMOVED***gMapEnvSource(in *api.Con***REMOVED***gMapEnvSource, out *Con***REMOVED***gMapEnvSource, s conversion.Scope) error {
...
// Convert_api_Con***REMOVED***gMapEnvSource_To_v1_Con***REMOVED***gMapEnvSource is an autogenerated conversion function.
func Convert_api_Con***REMOVED***gMapEnvSource_To_v1_Con***REMOVED***gMapEnvSource(in *api.Con***REMOVED***gMapEnvSource, out *Con***REMOVED***gMapEnvSource, s conversion.Scope) error {
	return autoConvert_api_Con***REMOVED***gMapEnvSource_To_v1_Con***REMOVED***gMapEnvSource(in, out, s)
}

func autoConvert_v1_Con***REMOVED***gMapKeySelector_To_api_Con***REMOVED***gMapKeySelector(in *Con***REMOVED***gMapKeySelector, out *api.Con***REMOVED***gMapKeySelector, s conversion.Scope) error {
	if err := Convert_v1_LocalObjectReference_To_api_LocalObjectReference(&in.LocalObjectReference, &out.LocalObjectReference, s); err != nil {
		return err
	}
	out.Key = in.Key
...
// Convert_v1_Con***REMOVED***gMapKeySelector_To_api_Con***REMOVED***gMapKeySelector is an autogenerated conversion function.
func Convert_v1_Con***REMOVED***gMapKeySelector_To_api_Con***REMOVED***gMapKeySelector(in *Con***REMOVED***gMapKeySelector, out *api.Con***REMOVED***gMapKeySelector, s conversion.Scope) error {
	return autoConvert_v1_Con***REMOVED***gMapKeySelector_To_api_Con***REMOVED***gMapKeySelector(in, out, s)
}

func autoConvert_api_Con***REMOVED***gMapKeySelector_To_v1_Con***REMOVED***gMapKeySelector(in *api.Con***REMOVED***gMapKeySelector, out *Con***REMOVED***gMapKeySelector, s conversion.Scope) error {
	if err := Convert_api_LocalObjectReference_To_v1_LocalObjectReference(&in.LocalObjectReference, &out.LocalObjectReference, s); err != nil {
		return err
	}
	out.Key = in.Key
...
// Convert_api_Con***REMOVED***gMapKeySelector_To_v1_Con***REMOVED***gMapKeySelector is an autogenerated conversion function.
func Convert_api_Con***REMOVED***gMapKeySelector_To_v1_Con***REMOVED***gMapKeySelector(in *api.Con***REMOVED***gMapKeySelector, out *Con***REMOVED***gMapKeySelector, s conversion.Scope) error {
	return autoConvert_api_Con***REMOVED***gMapKeySelector_To_v1_Con***REMOVED***gMapKeySelector(in, out, s)
}

func autoConvert_v1_Con***REMOVED***gMapList_To_api_Con***REMOVED***gMapList(in *Con***REMOVED***gMapList, out *api.Con***REMOVED***gMapList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]api.Con***REMOVED***gMap)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1_Con***REMOVED***gMapList_To_api_Con***REMOVED***gMapList is an autogenerated conversion function.
func Convert_v1_Con***REMOVED***gMapList_To_api_Con***REMOVED***gMapList(in *Con***REMOVED***gMapList, out *api.Con***REMOVED***gMapList, s conversion.Scope) error {
	return autoConvert_v1_Con***REMOVED***gMapList_To_api_Con***REMOVED***gMapList(in, out, s)
}

func autoConvert_api_Con***REMOVED***gMapList_To_v1_Con***REMOVED***gMapList(in *api.Con***REMOVED***gMapList, out *Con***REMOVED***gMapList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items == nil {
		out.Items = make([]Con***REMOVED***gMap, 0)
	} ***REMOVED*** {
		out.Items = *(*[]Con***REMOVED***gMap)(unsafe.Pointer(&in.Items))
	}
	return nil
}

// Convert_api_Con***REMOVED***gMapList_To_v1_Con***REMOVED***gMapList is an autogenerated conversion function.
func Convert_api_Con***REMOVED***gMapList_To_v1_Con***REMOVED***gMapList(in *api.Con***REMOVED***gMapList, out *Con***REMOVED***gMapList, s conversion.Scope) error {
	return autoConvert_api_Con***REMOVED***gMapList_To_v1_Con***REMOVED***gMapList(in, out, s)
}

func autoConvert_v1_Con***REMOVED***gMapProjection_To_api_Con***REMOVED***gMapProjection(in *Con***REMOVED***gMapProjection, out *api.Con***REMOVED***gMapProjection, s conversion.Scope) error {
	if err := Convert_v1_LocalObjectReference_To_api_LocalObjectReference(&in.LocalObjectReference, &out.LocalObjectReference, s); err != nil {
		return err
	}
...
// Convert_v1_Con***REMOVED***gMapProjection_To_api_Con***REMOVED***gMapProjection is an autogenerated conversion function.
func Convert_v1_Con***REMOVED***gMapProjection_To_api_Con***REMOVED***gMapProjection(in *Con***REMOVED***gMapProjection, out *api.Con***REMOVED***gMapProjection, s conversion.Scope) error {
	return autoConvert_v1_Con***REMOVED***gMapProjection_To_api_Con***REMOVED***gMapProjection(in, out, s)
}

func autoConvert_api_Con***REMOVED***gMapProjection_To_v1_Con***REMOVED***gMapProjection(in *api.Con***REMOVED***gMapProjection, out *Con***REMOVED***gMapProjection, s conversion.Scope) error {
	if err := Convert_api_LocalObjectReference_To_v1_LocalObjectReference(&in.LocalObjectReference, &out.LocalObjectReference, s); err != nil {
		return err
	}
...
// Convert_api_Con***REMOVED***gMapProjection_To_v1_Con***REMOVED***gMapProjection is an autogenerated conversion function.
func Convert_api_Con***REMOVED***gMapProjection_To_v1_Con***REMOVED***gMapProjection(in *api.Con***REMOVED***gMapProjection, out *Con***REMOVED***gMapProjection, s conversion.Scope) error {
	return autoConvert_api_Con***REMOVED***gMapProjection_To_v1_Con***REMOVED***gMapProjection(in, out, s)
}

func autoConvert_v1_Con***REMOVED***gMapVolumeSource_To_api_Con***REMOVED***gMapVolumeSource(in *Con***REMOVED***gMapVolumeSource, out *api.Con***REMOVED***gMapVolumeSource, s conversion.Scope) error {
	if err := Convert_v1_LocalObjectReference_To_api_LocalObjectReference(&in.LocalObjectReference, &out.LocalObjectReference, s); err != nil {
		return err
	}
	out.Items = *(*[]api.KeyToPath)(unsafe.Pointer(&in.Items))
...
// Convert_v1_Con***REMOVED***gMapVolumeSource_To_api_Con***REMOVED***gMapVolumeSource is an autogenerated conversion function.
func Convert_v1_Con***REMOVED***gMapVolumeSource_To_api_Con***REMOVED***gMapVolumeSource(in *Con***REMOVED***gMapVolumeSource, out *api.Con***REMOVED***gMapVolumeSource, s conversion.Scope) error {
	return autoConvert_v1_Con***REMOVED***gMapVolumeSource_To_api_Con***REMOVED***gMapVolumeSource(in, out, s)
}

func autoConvert_api_Con***REMOVED***gMapVolumeSource_To_v1_Con***REMOVED***gMapVolumeSource(in *api.Con***REMOVED***gMapVolumeSource, out *Con***REMOVED***gMapVolumeSource, s conversion.Scope) error {
	if err := Convert_api_LocalObjectReference_To_v1_LocalObjectReference(&in.LocalObjectReference, &out.LocalObjectReference, s); err != nil {
		return err
	}
	out.Items = *(*[]KeyToPath)(unsafe.Pointer(&in.Items))
...
// Convert_api_Con***REMOVED***gMapVolumeSource_To_v1_Con***REMOVED***gMapVolumeSource is an autogenerated conversion function.
func Convert_api_Con***REMOVED***gMapVolumeSource_To_v1_Con***REMOVED***gMapVolumeSource(in *api.Con***REMOVED***gMapVolumeSource, out *Con***REMOVED***gMapVolumeSource, s conversion.Scope) error {
	return autoConvert_api_Con***REMOVED***gMapVolumeSource_To_v1_Con***REMOVED***gMapVolumeSource(in, out, s)
}
...
func autoConvert_v1_EnvFromSource_To_api_EnvFromSource(in *EnvFromSource, out *api.EnvFromSource, s conversion.Scope) error {
	out.Pre***REMOVED***x = in.Pre***REMOVED***x
	out.Con***REMOVED***gMapRef = (*api.Con***REMOVED***gMapEnvSource)(unsafe.Pointer(in.Con***REMOVED***gMapRef))
...
func autoConvert_api_EnvFromSource_To_v1_EnvFromSource(in *api.EnvFromSource, out *EnvFromSource, s conversion.Scope) error {
	out.Pre***REMOVED***x = in.Pre***REMOVED***x
	out.Con***REMOVED***gMapRef = (*Con***REMOVED***gMapEnvSource)(unsafe.Pointer(in.Con***REMOVED***gMapRef))
...
func autoConvert_v1_EnvVarSource_To_api_EnvVarSource(in *EnvVarSource, out *api.EnvVarSource, s conversion.Scope) error {
	out.FieldRef = (*api.ObjectFieldSelector)(unsafe.Pointer(in.FieldRef))
	out.ResourceFieldRef = (*api.ResourceFieldSelector)(unsafe.Pointer(in.ResourceFieldRef))
	out.Con***REMOVED***gMapKeyRef = (*api.Con***REMOVED***gMapKeySelector)(unsafe.Pointer(in.Con***REMOVED***gMapKeyRef))
...
func autoConvert_api_EnvVarSource_To_v1_EnvVarSource(in *api.EnvVarSource, out *EnvVarSource, s conversion.Scope) error {
	out.FieldRef = (*ObjectFieldSelector)(unsafe.Pointer(in.FieldRef))
	out.ResourceFieldRef = (*ResourceFieldSelector)(unsafe.Pointer(in.ResourceFieldRef))
	out.Con***REMOVED***gMapKeyRef = (*Con***REMOVED***gMapKeySelector)(unsafe.Pointer(in.Con***REMOVED***gMapKeyRef))
...
func autoConvert_v1_ListOptions_To_api_ListOptions(in *ListOptions, out *api.ListOptions, s conversion.Scope) error {
	...
	if err := meta_v1.Convert_string_To_***REMOVED***elds_Selector(&in.FieldSelector, &out.FieldSelector, s); err != nil {
		return err
	}
...
func autoConvert_api_ListOptions_To_v1_ListOptions(in *api.ListOptions, out *ListOptions, s conversion.Scope) error {
	...
	if err := meta_v1.Convert_***REMOVED***elds_Selector_To_string(&in.FieldSelector, &out.FieldSelector, s); err != nil {
		return err
	}
	out.IncludeUninitialized = in.IncludeUninitialized
	out.Watch = in.Watch
...
func autoConvert_v1_NodeAf***REMOVED***nity_To_api_NodeAf***REMOVED***nity(in *NodeAf***REMOVED***nity, out *api.NodeAf***REMOVED***nity, s conversion.Scope) error {
...
// Convert_v1_NodeAf***REMOVED***nity_To_api_NodeAf***REMOVED***nity is an autogenerated conversion function.
func Convert_v1_NodeAf***REMOVED***nity_To_api_NodeAf***REMOVED***nity(in *NodeAf***REMOVED***nity, out *api.NodeAf***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_v1_NodeAf***REMOVED***nity_To_api_NodeAf***REMOVED***nity(in, out, s)
}

func autoConvert_api_NodeAf***REMOVED***nity_To_v1_NodeAf***REMOVED***nity(in *api.NodeAf***REMOVED***nity, out *NodeAf***REMOVED***nity, s conversion.Scope) error {
...
// Convert_api_NodeAf***REMOVED***nity_To_v1_NodeAf***REMOVED***nity is an autogenerated conversion function.
func Convert_api_NodeAf***REMOVED***nity_To_v1_NodeAf***REMOVED***nity(in *api.NodeAf***REMOVED***nity, out *NodeAf***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_api_NodeAf***REMOVED***nity_To_v1_NodeAf***REMOVED***nity(in, out, s)
}
...
func autoConvert_v1_PodAf***REMOVED***nity_To_api_PodAf***REMOVED***nity(in *PodAf***REMOVED***nity, out *api.PodAf***REMOVED***nity, s conversion.Scope) error {
	out.RequiredDuringSchedulingIgnoredDuringExecution = *(*[]api.PodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.RequiredDuringSchedulingIgnoredDuringExecution))
	out.PreferredDuringSchedulingIgnoredDuringExecution = *(*[]api.WeightedPodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.PreferredDuringSchedulingIgnoredDuringExecution))
	return nil
}

// Convert_v1_PodAf***REMOVED***nity_To_api_PodAf***REMOVED***nity is an autogenerated conversion function.
func Convert_v1_PodAf***REMOVED***nity_To_api_PodAf***REMOVED***nity(in *PodAf***REMOVED***nity, out *api.PodAf***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_v1_PodAf***REMOVED***nity_To_api_PodAf***REMOVED***nity(in, out, s)
}

func autoConvert_api_PodAf***REMOVED***nity_To_v1_PodAf***REMOVED***nity(in *api.PodAf***REMOVED***nity, out *PodAf***REMOVED***nity, s conversion.Scope) error {
	out.RequiredDuringSchedulingIgnoredDuringExecution = *(*[]PodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.RequiredDuringSchedulingIgnoredDuringExecution))
	out.PreferredDuringSchedulingIgnoredDuringExecution = *(*[]WeightedPodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.PreferredDuringSchedulingIgnoredDuringExecution))
	return nil
}

// Convert_api_PodAf***REMOVED***nity_To_v1_PodAf***REMOVED***nity is an autogenerated conversion function.
func Convert_api_PodAf***REMOVED***nity_To_v1_PodAf***REMOVED***nity(in *api.PodAf***REMOVED***nity, out *PodAf***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_api_PodAf***REMOVED***nity_To_v1_PodAf***REMOVED***nity(in, out, s)
}

func autoConvert_v1_PodAf***REMOVED***nityTerm_To_api_PodAf***REMOVED***nityTerm(in *PodAf***REMOVED***nityTerm, out *api.PodAf***REMOVED***nityTerm, s conversion.Scope) error {
...
// Convert_v1_PodAf***REMOVED***nityTerm_To_api_PodAf***REMOVED***nityTerm is an autogenerated conversion function.
func Convert_v1_PodAf***REMOVED***nityTerm_To_api_PodAf***REMOVED***nityTerm(in *PodAf***REMOVED***nityTerm, out *api.PodAf***REMOVED***nityTerm, s conversion.Scope) error {
	return autoConvert_v1_PodAf***REMOVED***nityTerm_To_api_PodAf***REMOVED***nityTerm(in, out, s)
}

func autoConvert_api_PodAf***REMOVED***nityTerm_To_v1_PodAf***REMOVED***nityTerm(in *api.PodAf***REMOVED***nityTerm, out *PodAf***REMOVED***nityTerm, s conversion.Scope) error {
	out.LabelSelector = (*meta_v1.LabelSelector)(unsafe.Pointer(in.LabelSelector))
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	out.TopologyKey = in.TopologyKey
	return nil
...
// Convert_api_PodAf***REMOVED***nityTerm_To_v1_PodAf***REMOVED***nityTerm is an autogenerated conversion function.
func Convert_api_PodAf***REMOVED***nityTerm_To_v1_PodAf***REMOVED***nityTerm(in *api.PodAf***REMOVED***nityTerm, out *PodAf***REMOVED***nityTerm, s conversion.Scope) error {
	return autoConvert_api_PodAf***REMOVED***nityTerm_To_v1_PodAf***REMOVED***nityTerm(in, out, s)
}

func autoConvert_v1_PodAntiAf***REMOVED***nity_To_api_PodAntiAf***REMOVED***nity(in *PodAntiAf***REMOVED***nity, out *api.PodAntiAf***REMOVED***nity, s conversion.Scope) error {
	out.RequiredDuringSchedulingIgnoredDuringExecution = *(*[]api.PodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.RequiredDuringSchedulingIgnoredDuringExecution))
	out.PreferredDuringSchedulingIgnoredDuringExecution = *(*[]api.WeightedPodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.PreferredDuringSchedulingIgnoredDuringExecution))
	return nil
}

// Convert_v1_PodAntiAf***REMOVED***nity_To_api_PodAntiAf***REMOVED***nity is an autogenerated conversion function.
func Convert_v1_PodAntiAf***REMOVED***nity_To_api_PodAntiAf***REMOVED***nity(in *PodAntiAf***REMOVED***nity, out *api.PodAntiAf***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_v1_PodAntiAf***REMOVED***nity_To_api_PodAntiAf***REMOVED***nity(in, out, s)
}

func autoConvert_api_PodAntiAf***REMOVED***nity_To_v1_PodAntiAf***REMOVED***nity(in *api.PodAntiAf***REMOVED***nity, out *PodAntiAf***REMOVED***nity, s conversion.Scope) error {
	out.RequiredDuringSchedulingIgnoredDuringExecution = *(*[]PodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.RequiredDuringSchedulingIgnoredDuringExecution))
	out.PreferredDuringSchedulingIgnoredDuringExecution = *(*[]WeightedPodAf***REMOVED***nityTerm)(unsafe.Pointer(&in.PreferredDuringSchedulingIgnoredDuringExecution))
	return nil
}

// Convert_api_PodAntiAf***REMOVED***nity_To_v1_PodAntiAf***REMOVED***nity is an autogenerated conversion function.
func Convert_api_PodAntiAf***REMOVED***nity_To_v1_PodAntiAf***REMOVED***nity(in *api.PodAntiAf***REMOVED***nity, out *PodAntiAf***REMOVED***nity, s conversion.Scope) error {
	return autoConvert_api_PodAntiAf***REMOVED***nity_To_v1_PodAntiAf***REMOVED***nity(in, out, s)
}
...
func autoConvert_v1_PodSpec_To_api_PodSpec(in *PodSpec, out *api.PodSpec, s conversion.Scope) error {
	...
	out.Af***REMOVED***nity = (*api.Af***REMOVED***nity)(unsafe.Pointer(in.Af***REMOVED***nity))
...
func autoConvert_api_PodSpec_To_v1_PodSpec(in *api.PodSpec, out *PodSpec, s conversion.Scope) error {
	...
	out.Hostname = in.Hostname
	out.Subdomain = in.Subdomain
	out.Af***REMOVED***nity = (*Af***REMOVED***nity)(unsafe.Pointer(in.Af***REMOVED***nity))
	out.SchedulerName = in.SchedulerName
...
func autoConvert_v1_ServiceSpec_To_api_ServiceSpec(in *ServiceSpec, out *api.ServiceSpec, s conversion.Scope) error {
	...
	out.SessionAf***REMOVED***nity = api.ServiceAf***REMOVED***nity(in.SessionAf***REMOVED***nity)
	out.LoadBalancerIP = in.LoadBalancerIP
	out.LoadBalancerSourceRanges = *(*[]string)(unsafe.Pointer(&in.LoadBalancerSourceRanges))
	out.ExternalName = in.ExternalName
	out.ExternalTraf***REMOVED***cPolicy = api.ServiceExternalTraf***REMOVED***cPolicyType(in.ExternalTraf***REMOVED***cPolicy)
...
func autoConvert_api_ServiceSpec_To_v1_ServiceSpec(in *api.ServiceSpec, out *ServiceSpec, s conversion.Scope) error {
	...
	out.ExternalIPs = *(*[]string)(unsafe.Pointer(&in.ExternalIPs))
	out.LoadBalancerIP = in.LoadBalancerIP
	out.SessionAf***REMOVED***nity = ServiceAf***REMOVED***nity(in.SessionAf***REMOVED***nity)
	out.LoadBalancerSourceRanges = *(*[]string)(unsafe.Pointer(&in.LoadBalancerSourceRanges))
	out.ExternalTraf***REMOVED***cPolicy = ServiceExternalTraf***REMOVED***cPolicyType(in.ExternalTraf***REMOVED***cPolicy)
	out.HealthCheckNodePort = in.HealthCheckNodePort
	return nil
}
...
func autoConvert_v1_VolumeProjection_To_api_VolumeProjection(in *VolumeProjection, out *api.VolumeProjection, s conversion.Scope) error {
	...
	out.Con***REMOVED***gMap = (*api.Con***REMOVED***gMapProjection)(unsafe.Pointer(in.Con***REMOVED***gMap))
	return nil
}
...
func autoConvert_api_VolumeProjection_To_v1_VolumeProjection(in *api.VolumeProjection, out *VolumeProjection, s conversion.Scope) error {
	...
	out.Con***REMOVED***gMap = (*Con***REMOVED***gMapProjection)(unsafe.Pointer(in.Con***REMOVED***gMap))
	return nil
}
...
func autoConvert_v1_VolumeSource_To_api_VolumeSource(in *VolumeSource, out *api.VolumeSource, s conversion.Scope) error {
	...
	out.FC = (*api.FCVolumeSource)(unsafe.Pointer(in.FC))
	out.AzureFile = (*api.AzureFileVolumeSource)(unsafe.Pointer(in.AzureFile))
	out.Con***REMOVED***gMap = (*api.Con***REMOVED***gMapVolumeSource)(unsafe.Pointer(in.Con***REMOVED***gMap))
	out.VsphereVolume = (*api.VsphereVirtualDiskVolumeSource)(unsafe.Pointer(in.VsphereVolume))
	out.Quobyte = (*api.QuobyteVolumeSource)(unsafe.Pointer(in.Quobyte))
	out.AzureDisk = (*api.AzureDiskVolumeSource)(unsafe.Pointer(in.AzureDisk))
	out.PhotonPersistentDisk = (*api.PhotonPersistentDiskVolumeSource)(unsafe.Pointer(in.PhotonPersistentDisk))
...
func autoConvert_api_VolumeSource_To_v1_VolumeSource(in *api.VolumeSource, out *VolumeSource, s conversion.Scope) error {
	...
	out.FC = (*FCVolumeSource)(unsafe.Pointer(in.FC))
	out.AzureFile = (*AzureFileVolumeSource)(unsafe.Pointer(in.AzureFile))
	out.Con***REMOVED***gMap = (*Con***REMOVED***gMapVolumeSource)(unsafe.Pointer(in.Con***REMOVED***gMap))
	out.VsphereVolume = (*VsphereVirtualDiskVolumeSource)(unsafe.Pointer(in.VsphereVolume))
	out.AzureDisk = (*AzureDiskVolumeSource)(unsafe.Pointer(in.AzureDisk))
	out.PhotonPersistentDisk = (*PhotonPersistentDiskVolumeSource)(unsafe.Pointer(in.PhotonPersistentDisk))
...
func autoConvert_v1_WeightedPodAf***REMOVED***nityTerm_To_api_WeightedPodAf***REMOVED***nityTerm(in *WeightedPodAf***REMOVED***nityTerm, out *api.WeightedPodAf***REMOVED***nityTerm, s conversion.Scope) error {
	out.Weight = in.Weight
	if err := Convert_v1_PodAf***REMOVED***nityTerm_To_api_PodAf***REMOVED***nityTerm(&in.PodAf***REMOVED***nityTerm, &out.PodAf***REMOVED***nityTerm, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_WeightedPodAf***REMOVED***nityTerm_To_api_WeightedPodAf***REMOVED***nityTerm is an autogenerated conversion function.
func Convert_v1_WeightedPodAf***REMOVED***nityTerm_To_api_WeightedPodAf***REMOVED***nityTerm(in *WeightedPodAf***REMOVED***nityTerm, out *api.WeightedPodAf***REMOVED***nityTerm, s conversion.Scope) error {
	return autoConvert_v1_WeightedPodAf***REMOVED***nityTerm_To_api_WeightedPodAf***REMOVED***nityTerm(in, out, s)
}

func autoConvert_api_WeightedPodAf***REMOVED***nityTerm_To_v1_WeightedPodAf***REMOVED***nityTerm(in *api.WeightedPodAf***REMOVED***nityTerm, out *WeightedPodAf***REMOVED***nityTerm, s conversion.Scope) error {
	out.Weight = in.Weight
	if err := Convert_api_PodAf***REMOVED***nityTerm_To_v1_PodAf***REMOVED***nityTerm(&in.PodAf***REMOVED***nityTerm, &out.PodAf***REMOVED***nityTerm, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_WeightedPodAf***REMOVED***nityTerm_To_v1_WeightedPodAf***REMOVED***nityTerm is an autogenerated conversion function.
func Convert_api_WeightedPodAf***REMOVED***nityTerm_To_v1_WeightedPodAf***REMOVED***nityTerm(in *api.WeightedPodAf***REMOVED***nityTerm, out *WeightedPodAf***REMOVED***nityTerm, s conversion.Scope) error {
	return autoConvert_api_WeightedPodAf***REMOVED***nityTerm_To_v1_WeightedPodAf***REMOVED***nityTerm(in, out, s)
}
