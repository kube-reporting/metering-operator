...
func (*NetworkPolicy) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{0} }
...
func (*NetworkPolicyList) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{2} }

func (m *NetworkPolicyPeer) Reset()                    { *m = NetworkPolicyPeer{} }
func (*NetworkPolicyPeer) ProtoMessage()               {}
func (*NetworkPolicyPeer) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{3} }

func (m *NetworkPolicyPort) Reset()                    { *m = NetworkPolicyPort{} }
func (*NetworkPolicyPort) ProtoMessage()               {}
func (*NetworkPolicyPort) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{4} }

func (m *NetworkPolicySpec) Reset()                    { *m = NetworkPolicySpec{} }
func (*NetworkPolicySpec) ProtoMessage()               {}
func (*NetworkPolicySpec) Descriptor() ([]byte, []int) { return ***REMOVED***leDescriptorGenerated, []int{5} }
...
func init() {
	proto.RegisterFile("k8s.io/client-go/pkg/apis/networking/v1/generated.proto", ***REMOVED***leDescriptorGenerated)
}
