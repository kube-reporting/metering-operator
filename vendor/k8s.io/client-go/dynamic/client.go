...
type Interface interface {
	...
	// Resource returns an API interface to the speci***REMOVED***ed resource for this client's
...
// ResourceInterface is an API interface to a speci***REMOVED***c resource under a
// dynamic client.
type ResourceInterface interface {
	// List returns a list of objects for this resource.
	List(opts metav1.ListOptions) (runtime.Object, error)
	// Get gets the resource with the speci***REMOVED***ed name.
	Get(name string, opts metav1.GetOptions) (*unstructured.Unstructured, error)
	// Delete deletes the resource with the speci***REMOVED***ed name.
...
// NewClient returns a new client based on the passed in con***REMOVED***g. The
// codec is ignored, as the dynamic client uses it's own codec.
func NewClient(conf *restclient.Con***REMOVED***g) (*Client, error) {
	// avoid changing the original con***REMOVED***g
	confCopy := *conf
	conf = &confCopy

	contentCon***REMOVED***g := ContentCon***REMOVED***g()
	contentCon***REMOVED***g.GroupVersion = conf.GroupVersion
	if conf.NegotiatedSerializer != nil {
		contentCon***REMOVED***g.NegotiatedSerializer = conf.NegotiatedSerializer
	}
	conf.ContentCon***REMOVED***g = contentCon***REMOVED***g
...
// ResourceClient is an API interface to a speci***REMOVED***c resource under a
...
// ContentCon***REMOVED***g returns a restclient.ContentCon***REMOVED***g for dynamic types.
func ContentCon***REMOVED***g() restclient.ContentCon***REMOVED***g {
	...
	return restclient.ContentCon***REMOVED***g{
...
// speci***REMOVED***ed version before converting it to query parameters, and falls back to
// converting to v1 if the object is not registered in the speci***REMOVED***ed version.
