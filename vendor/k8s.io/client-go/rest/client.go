...
func (c *RESTClient) Verb(verb string) *Request {
	...
	if c.Client == nil {
		return NewRequest(nil, verb, c.base, c.versionedAPIPath, c.contentCon***REMOVED***g, c.serializers, backoff, c.Throttle)
	}
	return NewRequest(c.Client, verb, c.base, c.versionedAPIPath, c.contentCon***REMOVED***g, c.serializers, backoff, c.Throttle)
}
