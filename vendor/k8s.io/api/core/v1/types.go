...
type VolumeMount struct {
	...
	// This ***REMOVED***eld is alpha in 1.8 and can be reworked or removed in a future
	// release.
	// +optional
...
type ServiceSpec struct {
	...
	// of peer discovery.
	// This ***REMOVED***eld will replace the service.alpha.kubernetes.io/tolerate-unready-endpoints
...
type NodeCon***REMOVED***gSource struct {
	metav1.TypeMeta `json:",inline"`
	Con***REMOVED***gMapRef    *ObjectReference `json:"con***REMOVED***gMapRef,omitempty" protobuf:"bytes,1,opt,name=con***REMOVED***gMapRef"`
}
...
const (
	...
	// NodeCon***REMOVED***gOK indicates whether the kubelet is correctly con***REMOVED***gured
	NodeCon***REMOVED***gOK NodeConditionType = "Con***REMOVED***gOK"
)
