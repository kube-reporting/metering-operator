...
// generate functions that ef***REMOVED***ciently convert between same-name types in each
...
// assignment whenever possible.  The resulting ***REMOVED***le will be stored in the same
// directory as the processed source package.
//
// Generation is governed by comment tags in the source.  Any package may
// request Conversion generation by including a comment in the ***REMOVED***le-comments of
// one ***REMOVED***le, of the form:
//   // +k8s:conversion-gen=<import-path-of-peer-package>
//
// When generating for a package, individual types or ***REMOVED***elds of structs may opt
...
func main() {
	...
	pflag.CommandLine.StringSliceVar(&customArgs.BasePeerDirs, "base-peer-dirs", customArgs.BasePeerDirs,
		"Comma-separated list of apimachinery import paths which are considered, after tag-speci***REMOVED***ed peers, for conversions. Only change these if you have very good reasons.")
	pflag.CommandLine.StringSliceVar(&customArgs.ExtraPeerDirs, "extra-peer-dirs", customArgs.ExtraPeerDirs,
		"Application speci***REMOVED***c comma-separated list of import paths which are considered, after tag-speci***REMOVED***ed peers and base-peer-dirs, for conversions.")
	...
	// Override defaults.
	arguments.GoHeaderFilePath = ***REMOVED***lepath.Join(args.DefaultSourceTree(), "k8s.io/kubernetes/hack/boilerplate/boilerplate.go.txt")
