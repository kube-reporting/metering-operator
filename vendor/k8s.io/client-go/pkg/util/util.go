...
// Tests whether all pointer ***REMOVED***elds in a struct are nil.  This is useful when,
...
func FileExists(***REMOVED***lename string) (bool, error) {
	if _, err := os.Stat(***REMOVED***lename); os.IsNotExist(err) {
		return false, nil
	} ***REMOVED*** if err != nil {
		return false, err
	}
...
// ReadDirNoStat returns a string of ***REMOVED***les/directories contained
