...
type noopDrv struct {
	...
	S    []string
	B    [][]byte
	mks  []bool    // stack. if map (true), ***REMOVED*** if array (false)
...
func (h *noopDrv) ContainerType() (vt valueType) {
	...
	// for kstruct: at least one out of every 2 times, return one of valueTypeMap or Array (***REMOVED*** kstruct bombs)
	// however, every 10th time it is called, we just return something ***REMOVED***.
