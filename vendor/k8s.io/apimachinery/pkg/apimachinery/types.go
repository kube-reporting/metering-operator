...
type GroupMeta struct {
	...
	// SelfLinker can set or get the SelfLink ***REMOVED***eld of all API types.
	// TODO: when versioning changes, make this part of each API de***REMOVED***nition.
	...
	// function provided below once every place that populates this ***REMOVED***eld has been changed.
...
// string, or an error if the version is not known.
// TODO: Remove the "Default" pre***REMOVED***x.
...
// TODO: remove the "Interfaces" suf***REMOVED***x and make this also maintain the
