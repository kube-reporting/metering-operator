 ...
 * CDDL HEADER START
 *
 * The contents of this ***REMOVED***le are subject to the terms of the
 * Common Development and Distribution License, Version 1.0 only
 * (the "License").  You may not use this ***REMOVED***le except in compliance
 * with the License.
 *
 * You can obtain a copy of the license at usr/src/OPENSOLARIS.LICENSE
 * or http://www.opensolaris.org/os/licensing.
 * See the License for the speci***REMOVED***c language governing permissions
 * and limitations under the License.
 *
 * When distributing Covered Code, include this CDDL HEADER in each
 * ***REMOVED***le and include the License ***REMOVED***le at usr/src/OPENSOLARIS.LICENSE.
 * If applicable, add the following below this CDDL HEADER, with the
 * ***REMOVED***elds enclosed by brackets "[]" replaced with your own identifying
