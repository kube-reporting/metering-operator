...
func newRowSet(client *thriftlib.TCLIServiceClient, opHandle *thriftlib.TOperationHandle, con***REMOVED***g *con***REMOVED***g) *rowSet {
	return &rowSet{
		client:   client,
		opHandle: opHandle,
		con***REMOVED***g:   con***REMOVED***g,
...
func (r *rowSet) fetchNext() error {
	...
	req.MaxRows = r.con***REMOVED***g.batchSize
