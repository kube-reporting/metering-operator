...
type Summary struct {
	...
	SampleSum        *float64    `protobuf:"***REMOVED***xed64,2,opt,name=sample_sum" json:"sample_sum,omitempty"`
...
type Bucket struct {
	...
	UpperBound       *float64 `protobuf:"***REMOVED***xed64,2,opt,name=upper_bound" json:"upper_bound,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
