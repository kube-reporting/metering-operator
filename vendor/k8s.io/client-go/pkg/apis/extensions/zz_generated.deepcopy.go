...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_extensions_RollbackCon***REMOVED***g, InType: reflect.TypeOf(&RollbackCon***REMOVED***g{})},
...
// DeepCopy_extensions_RollbackCon***REMOVED***g is an autogenerated deepcopy function.
func DeepCopy_extensions_RollbackCon***REMOVED***g(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*RollbackCon***REMOVED***g)
		out := out.(*RollbackCon***REMOVED***g)
		*out = *in
		return nil
	}
}
