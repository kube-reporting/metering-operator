...
func (d *DiscoveryClient) SwaggerSchema(version schema.GroupVersion) (*swagger.ApiDeclaration, error) {
	...
	var path string
	if len(d.LegacyPre***REMOVED***x) > 0 && version == v1.SchemeGroupVersion {
		path = "/swaggerapi" + d.LegacyPre***REMOVED***x + "/" + version.Version
	} ***REMOVED*** {
...
// NewDiscoveryClientForCon***REMOVED***g creates a new DiscoveryClient for the given con***REMOVED***g. If
