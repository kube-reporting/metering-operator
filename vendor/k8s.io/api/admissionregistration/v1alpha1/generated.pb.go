...
func init() {
	proto.RegisterType((*AdmissionHookClientCon***REMOVED***g)(nil), "k8s.io.api.admissionregistration.v1alpha1.AdmissionHookClientCon***REMOVED***g")
	proto.RegisterType((*ExternalAdmissionHook)(nil), "k8s.io.api.admissionregistration.v1alpha1.ExternalAdmissionHook")
	proto.RegisterType((*ExternalAdmissionHookCon***REMOVED***guration)(nil), "k8s.io.api.admissionregistration.v1alpha1.ExternalAdmissionHookCon***REMOVED***guration")
	proto.RegisterType((*ExternalAdmissionHookCon***REMOVED***gurationList)(nil), "k8s.io.api.admissionregistration.v1alpha1.ExternalAdmissionHookCon***REMOVED***gurationList")
