...
var map_PolicyRule = map[string]string{
	...
	"resources":       "Resources is a list of resources this rule applies to.  '*' represents all resources in the speci***REMOVED***ed apiGroups. '*/foo' represents the subresource 'foo' for all resources in the speci***REMOVED***ed apiGroups.",
