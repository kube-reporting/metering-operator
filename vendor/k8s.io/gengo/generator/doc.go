...
// Package generator de***REMOVED***nes an interface for code generators to implement.
//
...
// interface de***REMOVED***nitions for explanations. All output will have gofmt called on
