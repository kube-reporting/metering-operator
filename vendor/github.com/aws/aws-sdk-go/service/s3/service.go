...
const (
	...
	ServiceID   = "S3"        // ServiceID is a unique identifer of a speci***REMOVED***c service.
)
...
//
//     // Create a S3 client with additional con***REMOVED***guration
//     svc := s3.New(mySession, aws.NewCon***REMOVED***g().WithRegion("us-west-2"))
func New(p client.Con***REMOVED***gProvider, cfgs ...*aws.Con***REMOVED***g) *S3 {
...
func newClient(cfg aws.Con***REMOVED***g, handlers request.Handlers, endpoint, signingRegion, signingName string) *S3 {
	svc := &S3{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
