...
func (resolver *DependencyResolver) ResolveDependencies(namespace string, inputDefs []metering.ReportGenerationQueryInputDefinition, inputVals []metering.ReportGenerationQueryInputValue) (*DependencyResolutionResult, error) {
...
func (resolver *DependencyResolver) resolveDependencies(namespace string, resolverCtx *resolverContext, inputDefs []metering.ReportGenerationQueryInputDefinition, inputVals []metering.ReportGenerationQueryInputValue, depth, maxDepth int) error {
	if depth >= maxDepth {
