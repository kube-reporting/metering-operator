...
images/chargeback-helm-operator/tectonic-chargeback-0.1.0.tgz: $(shell find charts -type f)
...
images/chargeback-helm-operator/openshift-chargeback-0.1.0.tgz: $(shell find charts -type f)
