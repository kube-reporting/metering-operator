...
var map_Con***REMOVED***gMap = map[string]string{
	...
	"metadata": "Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata",
	"data":     "Data contains the con***REMOVED***guration data. Each key must consist of alphanumeric characters, '-', '_' or '.'.",
}
...
var map_DeleteOptions = map[string]string{
	...
	"gracePeriodSeconds": "The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the speci***REMOVED***ed type will be used. Defaults to a per object value if not speci***REMOVED***ed. zero means delete immediately.",
	"preconditions":      "Must be ful***REMOVED***lled before a deletion is carried out. If not possible, a 409 Conflict status will be returned.",
	"orphanDependents":   "Deprecated: please use the PropagationPolicy, this ***REMOVED***eld will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \"orphan\" ***REMOVED***nalizer will be added to/removed from the object's ***REMOVED***nalizers list. Either this ***REMOVED***eld or PropagationPolicy may be set, but not both.",
	"PropagationPolicy":  "Whether and how garbage collection will be performed. Either this ***REMOVED***eld or OrphanDependents may be set, but not both. The default policy is decided by the existing ***REMOVED***nalizer set in the metadata.***REMOVED***nalizers and the resource-speci***REMOVED***c default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.",
}
...
var map_EnvFromSource = map[string]string{
	...
	"pre***REMOVED***x":       "An optional identifer to prepend to each key in the Con***REMOVED***gMap. Must be a C_IDENTIFIER.",
...
var map_ListOptions = map[string]string{
	...
	"***REMOVED***eldSelector":        "A selector to restrict the list of returned objects by their ***REMOVED***elds. Defaults to everything.",
	"includeUninitialized": "If true, partially initialized resources are included in the response.",
	"watch":                "Watch for changes to the described resources and return them as a stream of add, update, and remove noti***REMOVED***cations. Specify resourceVersion.",
	"resourceVersion":      "When speci***REMOVED***ed with a watch call, shows changes that occur after that particular version of a resource. Defaults to changes from the beginning of history. When speci***REMOVED***ed for list: - if unset, then the result is returned from remote storage based on quorum-read flag; - if it's 0, then we simply return what we currently have in cache, no guarantee; - if set to non zero, then the result is at least as fresh as given rv.",
...
var map_ObjectMeta = map[string]string{
	...
	"name":                       "Name must be unique within a namespace. Is required when creating resources, although some resources may allow a client to request the generation of an appropriate name automatically. Name is primarily intended for creation idempotence and con***REMOVED***guration de***REMOVED***nition. Cannot be updated. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names",
	"generateName":               "GenerateName is an optional pre***REMOVED***x, used by the server, to generate a unique name ONLY IF the Name ***REMOVED***eld has not been provided. If this ***REMOVED***eld is used, the name returned to the client will be different than the name passed. This value will also be combined with a unique suf***REMOVED***x. The provided value has the same validation rules as the Name ***REMOVED***eld, and may be truncated by the length of the suf***REMOVED***x required to make the value unique on the server.\n\nIf this ***REMOVED***eld is speci***REMOVED***ed and the generated name exists, the server will NOT return a 409 - instead, it will either return 201 Created or 500 with Reason ServerTimeout indicating a unique name could not be found in the time allotted, and the client should retry (optionally after the time indicated in the Retry-After header).\n\nApplied only if Name is not speci***REMOVED***ed. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#idempotency",
	"namespace":                  "Namespace de***REMOVED***nes the space within each name must be unique. An empty namespace is equivalent to the \"default\" namespace, but \"default\" is the canonical representation. Not all objects are required to be scoped to a namespace - the value of this ***REMOVED***eld for those objects will be empty.\n\nMust be a DNS_LABEL. Cannot be updated. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/",
	"selfLink":                   "SelfLink is a URL representing this object. Populated by the system. Read-only.",
	"uid":                        "UID is the unique in time and space value for this object. It is typically generated by the server on successful creation of a resource and is not allowed to change on PUT operations.\n\nPopulated by the system. Read-only. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#uids",
	"resourceVersion":            "An opaque value that represents the internal version of this object that can be used by clients to determine when objects have changed. May be used for optimistic concurrency, change detection, and the watch operation on a resource or set of resources. Clients must treat these values as opaque and passed unmodi***REMOVED***ed back to the server. They may only be valid for a particular resource or set of resources.\n\nPopulated by the system. Read-only. Value must be treated as opaque by clients and . More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#concurrency-control-and-consistency",
	"generation":                 "A sequence number representing a speci***REMOVED***c generation of the desired state. Populated by the system. Read-only.",
	"creationTimestamp":          "CreationTimestamp is a timestamp representing the server time when this object was created. It is not guaranteed to be set in happens-before order across separate operations. Clients may not set this value. It is represented in RFC3339 form and is in UTC.\n\nPopulated by the system. Read-only. Null for lists. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata",
	"deletionTimestamp":          "DeletionTimestamp is RFC 3339 date and time at which this resource will be deleted. This ***REMOVED***eld is set by the server when a graceful deletion is requested by the user, and is not directly settable by a client. The resource is expected to be deleted (no longer visible from resource lists, and not reachable by name) after the time in this ***REMOVED***eld. Once set, this value may not be unset or be set further into the future, although it may be shortened or the resource may be deleted prior to this time. For example, a user may request that a pod is deleted in 30 seconds. The Kubelet will react by sending a graceful termination signal to the containers in the pod. After that 30 seconds, the Kubelet will send a hard termination signal (SIGKILL) to the container and after cleanup, remove the pod from the API. In the presence of network partitions, this object may still exist after this timestamp, until an administrator or automated process can determine the resource is fully terminated. If not set, graceful deletion of the object has not been requested.\n\nPopulated by the system when a graceful deletion is requested. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata",
	...
	"ownerReferences":            "List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller ***REMOVED***eld set to true. There cannot be more than one managing controller.",
	"initializers":               "An initializer is a controller which enforces some system invariant at object creation time. This ***REMOVED***eld is a list of initializers that have not yet acted on this object. If nil or empty, this object has been completely initialized. Otherwise, the object is considered uninitialized and is hidden (in list/watch and get calls) from clients that haven't explicitly asked to observe uninitialized objects.\n\nWhen an object is created, the system will populate this list with the current set of initializers. Only privileged users may set or modify this list. Once it is empty, it may not be modi***REMOVED***ed further by any user.",
	"***REMOVED***nalizers":                 "Must be empty before the object is deleted from the registry. Each entry is an identi***REMOVED***er for the responsible component that will remove the entry from the list. If the deletionTimestamp of the object is non-nil, entries in this list can only be removed.",
	"clusterName":                "The name of the cluster which the object belongs to. This is used to distinguish resources with same name and namespace in different clusters. This ***REMOVED***eld is not set anywhere right now and apiserver is going to ignore it if set in create or update request.",
}
...
var map_PersistentVolumeClaimSpec = map[string]string{
	...
	"volumeMode":       "volumeMode de***REMOVED***nes what type of volume is required by the claim. Value of Filesystem is implied when not included in claim spec. This is an alpha feature and may change in the future.",
}
...
var map_PersistentVolumeSpec = map[string]string{
	...
	"volumeMode":                    "volumeMode de***REMOVED***nes if a volume is intended to be used with a formatted ***REMOVED***lesystem or to remain in raw block state. Value of Filesystem is implied when not included in spec. This is an alpha feature and may change in the future.",
}
...
var map_PodSpec = map[string]string{
	...
	"priorityClassName":             "If speci***REMOVED***ed, indicates the pod's priority. \"SYSTEM\" is a special keyword which indicates the highest priority. Any other name must be de***REMOVED***ned by creating a PriorityClass object with that name. If not speci***REMOVED***ed, the pod priority will be default or zero if there is no default.",
	...
	"dnsCon***REMOVED***g":                     "Speci***REMOVED***es the DNS parameters of a pod. Parameters speci***REMOVED***ed here will be merged to the generated DNS con***REMOVED***guration based on DNSPolicy. This is an alpha feature introduced in v1.9 and CustomPodDNS feature gate must be enabled to use it.",
}
...
var map_PodStatus = map[string]string{
	...
	"qosClass":              "The Quality of Service (QOS) classi***REMOVED***cation assigned to the pod based on resource requirements See PodQOSClass type for available QOS classes More info: https://github.com/kubernetes/kubernetes/blob/master/docs/design/resource-qos.md",
}
...
var map_ServiceSpec = map[string]string{
	...
	"publishNotReadyAddresses": "publishNotReadyAddresses, when set to true, indicates that DNS implementations must publish the notReadyAddresses of subsets for the Endpoints associated with the Service. The default value is false. The primary use case for setting this ***REMOVED***eld is to use a StatefulSet's Headless Service to propagate SRV records for its Pods without respect to their readiness for purpose of peer discovery. This ***REMOVED***eld will replace the service.alpha.kubernetes.io/tolerate-unready-endpoints when that annotation is deprecated and all clients have been converted to use this ***REMOVED***eld.",
...
var map_VolumeMount = map[string]string{
	...
	"mountPropagation": "mountPropagation determines how mounts are propagated from the host to container and the other way around. When not set, MountPropagationHostToContainer is used. This ***REMOVED***eld is alpha in 1.8 and can be reworked or removed in a future release.",
}
