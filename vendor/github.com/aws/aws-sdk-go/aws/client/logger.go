...
func logRequest(r *request.Request) {
	...
	if err != nil {
		r.Con***REMOVED***g.Logger.Log(fmt.Sprintf(logReqErrMsg, r.ClientInfo.ServiceName, r.Operation.Name, err))
		return
	}
	...
	r.Con***REMOVED***g.Logger.Log(fmt.Sprintf(logReqMsg, r.ClientInfo.ServiceName, r.Operation.Name, string(dumpedBody)))
}
...
func logResponse(r *request.Request) {
	...
	handlerFn := func(req *request.Request) {
		...
		if req.Con***REMOVED***g.LogLevel.Matches(aws.LogDebugWithHTTPBody) {
