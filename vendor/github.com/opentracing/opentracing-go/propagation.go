...
var (
	...
	// Tracer.Extract() is valid and uncorrupted but has insuf***REMOVED***cient
...
type TextMapWriter interface {
	...
	// same key leads to unde***REMOVED***ned behavior.
	//
	// NOTE: The backing store for the TextMapWriter may contain data unrelated
	// to SpanContext. As such, Inject() and Extract() implementations that
	// call the TextMapWriter and TextMapReader interfaces must agree on a
	// pre***REMOVED***x or other convention to distinguish their own key:value pairs.
	Set(key, val string)
}
...
// HTTPHeadersCarrier satis***REMOVED***es both TextMapWriter and TextMapReader.
//
